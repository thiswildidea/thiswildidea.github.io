...
/*! ./src/index.js */
"./src/index.js")}}).default};const f=e(u.exports=c()),p={name:"funPrintJs",setup(){const e=n({});return{onPrintJs:()=>{f({printable:"printRef",type:"html",css:["//at.alicdn.com/t/font_2298093_o73r8wjdhlg.css","https://unpkg.com/element-plus/lib/theme-chalk/index.css"],scanStyles:!1,style:"@media print{.mb15{margin-bottom:15px;}.el-button--small i.iconfont{font-size: 12px !important;margin-right: 5px;}}"})},...r(e)}}},m={id:"printRef"},b=d(" 点击打印演示 ");const y=t(p,[["render",function(e,t,n,r,d,c){const u=o("el-alert"),f=o("SvgIcon"),p=o("el-button"),y=o("el-card");return s(),i("div",m,[a(y,{shadow:"hover",header:"打印演示"},{default:l((()=>[a(u,{title:"感谢优秀的 `print-js`，项目地址：https://github.com/crabbly/Print.js。请在打印弹窗 `更多设置` 中开启 `背景图形。`",type:"success",closable:!1,class:"mb15"}),a(p,{onClick:r.onPrintJs,size:"small",type:"primary"},{default:l((()=>[a(f,{name:"iconfont icon-dayin"}),b])),_:1},8,["onClick"])])),_:1})])}]]);export{y as default};
