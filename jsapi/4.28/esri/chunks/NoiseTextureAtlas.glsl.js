...
//>>built
define("exports ./vec2f64 ../views/3d/environment/NoiseTextureAtlasConfiguration ../views/3d/environment/NoiseTextureAtlasDimensions ../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl ../views/3d/webgl-engine/core/shaderModules/Float2PassUniform ../views/3d/webgl-engine/core/shaderModules/interfaces ../views/3d/webgl-engine/core/shaderModules/ShaderBuilder".split(" "),function(d,k,e,b,l,m,a,n){function g(f){const c=new n.ShaderBuilder;c.include(l.ScreenSpacePass,!1);c.fragment.code.add(a.glsl`float remap(float x, float low1, float high1, float low2, float high2) {
