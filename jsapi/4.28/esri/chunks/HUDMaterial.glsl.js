...
posProj = alignToPixelOrigin(posProj, viewport.zw);
  ...
  `;switch(a.output){case h.ShaderOutput.Color:f.code.add(b.glsl`
        ...
        }`);break;case h.ShaderOutput.Highlight:f.constants.add("occludedHighlightFlag","vec4",w.occludedHighlightFlag).add("unoccludedHighlightFlag","vec4",w.unoccludedHighlightFlag),f.code.add(b.glsl`
        void main() {
          ${e}
          if (voccluded == 1.0) {
