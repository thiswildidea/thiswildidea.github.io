...
//>>built
define(["exports","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DDrawUniform"],function(a,g,b,h,k){function e(){const c=new h.ShaderBuilder,{outputs:l,fragment:d}=c;c.include(g.ScreenSpacePass);d.uniforms.add(new k.Texture2DDrawUniform("textureInput",m=>m.input));d.constants.add("outlineSize","int",5);l.add("fragGrid",
