...
function(r,l,t,e,w,x,y,z,A,B,C,D,q,E,u,F,c,G,H,I,J,m,n){function v(a){const b=new H.ShaderBuilder,p=a.multipassEnabled&&(a.output===e.ShaderOutput.Color||a.output===e.ShaderOutput.Alpha),f=a.space===n.LineMarkerSpace.World;b.include(x.RibbonVertexPosition,a);b.include(z.MarkerSizing,a);a.output===e.ShaderOutput.Depth&&b.include(y.OutputDepth,a);const {vertex:d,fragment:k}=b;k.include(D.RgbaFloatEncoding);q.addProjViewLocalOrigin(d,a);b.attributes.add(m.VertexAttribute.POSITION,"vec3");b.attributes.add(m.VertexAttribute.UV0,
