...
function(f,n,g,r,t,u,h,k,e,v,l){function p(){const c=new v.ShaderBuilder,d=c.fragment;c.include(r.ScreenSpacePass);d.include(t.ReadLinearDepth);c.include(u.CameraSpace);d.uniforms.add(new k.FloatPassUniform("radius",(a,b)=>m(b.camera)));d.code.add(e.glsl`vec3 sphere[16];
void fillSphere() {
