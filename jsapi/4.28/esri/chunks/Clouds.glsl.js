...
fragColor = vec4(shading, totalTransmittance, shading, totalTransmittance);
}`);return k}class p extends b.NoParameters{constructor(){super(...arguments);this.coverage=this.cloudHeight=this.smoothness=this.density=this.absorption=this.detailSize=this.cloudSize=this.cloudRadius=0;this.raymarchingSteps=u.cloudPresets.default.raymarchingSteps;this.weatherTile=l.create()}}class q extends b.NoParameters{constructor(){super(...arguments);this.viewMatrix=r.create()}}const A=l.create(),B=Object.freeze(Object.defineProperty({__proto__:null,CloudsDrawParameters:q,CloudsPassParameters:p,
build:n},Symbol.toStringTag,{value:"Module"}));g.Clouds=B;g.CloudsDrawParameters=q;g.CloudsPassParameters=p;g.build=n});