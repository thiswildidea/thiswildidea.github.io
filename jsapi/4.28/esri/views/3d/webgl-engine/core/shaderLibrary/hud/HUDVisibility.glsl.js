...
new l.Texture2DPassUniform("hudVisibilityTexture",(e,a)=>a.hudVisibility?.colorTexture));b.vertex.include(f.AlignPixel);b.vertex.code.add(k.glsl`bool testHUDVisibility(vec4 posProj) {
