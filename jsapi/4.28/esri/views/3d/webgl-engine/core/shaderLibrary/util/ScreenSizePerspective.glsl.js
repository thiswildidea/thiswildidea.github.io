...
//>>built
define(["exports","../../../../../../chunks/vec3","../../../../../../chunks/vec3f64","../../shaderModules/Float3PassUniform","../../shaderModules/interfaces"],function(c,g,h,e,b){function f(a){return g.set(k,a.parameters.divisor,a.parameters.offset,a.minScaleFactor)}const k=h.create();c.ScreenSizePerspective=function(a){a.vertex.code.add(b.glsl`float screenSizePerspectiveViewAngleDependentFactor(float absCosAngle) {
