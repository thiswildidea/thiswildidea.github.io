...
//>>built
define("exports ../../../../../../chunks/vec3f64 ../output/BlendOptions ./BackgroundGrid.glsl ../util/BlendModes.glsl ../../shaderModules/Float3PassUniform ../../shaderModules/FloatPassUniform ../../shaderModules/interfaces ../../shaderModules/Texture2DPassUniform".split(" "),function(b,m,n,p,q,r,t,c,u){b.BlendLayersOutput=void 0;(function(a){a[a.Composite=0]="Composite";a[a.ColorComposite=1]="ColorComposite";a[a.GridComposite=2]="GridComposite";a[a.GroupBackgroundComposite=3]="GroupBackgroundComposite";
a[a.COUNT=4]="COUNT"})(b.BlendLayersOutput||(b.BlendLayersOutput={}));b.BaseOpacityMode=void 0;(function(a){a[a.NotRequired=0]="NotRequired";a[a.Required=1]="Required";a[a.COUNT=2]="COUNT"})(b.BaseOpacityMode||(b.BaseOpacityMode={}));b.PremultipliedAlphaSource=void 0;(function(a){a[a.Off=0]="Off";a[a.On=1]="On";a[a.COUNT=2]="COUNT"})(b.PremultipliedAlphaSource||(b.PremultipliedAlphaSource={}));class v extends c.NoParameters{constructor(){super(...arguments);this.baseOpacity=1;this.backgroundColor=
m.ZEROS;this.fboTexture=null}}b.TileBackground=function(a,d){const g=d.output===b.BlendLayersOutput.GridComposite,h=d.output===b.BlendLayersOutput.ColorComposite,k=d.output===b.BlendLayersOutput.GroupBackgroundComposite,l=d.output===b.BlendLayersOutput.Composite;g&&a.fragment.include(p.BackgroundGrid);h&&a.fragment.uniforms.add(new r.Float3PassUniform("backgroundColor",e=>e.backgroundColor));const f=d.baseOpacityMode===b.BaseOpacityMode.Required;f&&a.fragment.uniforms.add(new t.FloatPassUniform("baseOpacity",
