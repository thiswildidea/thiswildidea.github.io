...
(a,c)=>a.glowWidth*c.camera.pixelRatio),new e.FloatPassUniform("glowFalloff",a=>a.glowFalloff),new g.Float3PassUniform("innerColor",a=>a.innerColor),new e.FloatPassUniform("innerWidth",(a,c)=>a.innerWidth*c.camera.pixelRatio),new h.Texture2DPassUniform("depthMap",(a,c)=>c.linearDepth?.colorTexture),new n.Float2PassUniform("nearFar",(a,c)=>c.camera.nearFar),new h.Texture2DPassUniform("frameColor",(a,c)=>c.mainColor));b.code.add(d.glsl`vec4 blendPremultiplied(vec4 source, vec4 dest) {
