...
v,d,l,m,h,w,n,x,y,z,p,q,r,c,t,A){u.DefaultMaterialAuxiliaryPasses=function(b,a){const {vertex:e,fragment:f}=b,g=a.hasColorTexture&&a.alphaDiscardMode!==A.AlphaDiscardMode.Opaque;switch(a.output){case d.ShaderOutput.Depth:case d.ShaderOutput.Shadow:case d.ShaderOutput.ShadowHighlight:case d.ShaderOutput.ShadowExcludeHighlight:case d.ShaderOutput.ObjectAndLayerIdColor:r.addProjViewLocalOrigin(e,a);b.include(m.Transform,a);b.include(n.TextureCoordinateAttribute,a);b.include(p.VisualVariables,a);b.include(y.OutputDepth,
a);b.include(l.SliceDraw,a);b.include(w.ObjectAndLayerIdColor,a);v.addNearFar(b);b.varyings.add("depth","float");g&&f.uniforms.add(new t.Texture2DPassUniform("tex",k=>k.texture));e.code.add(c.glsl`void main(void) {
