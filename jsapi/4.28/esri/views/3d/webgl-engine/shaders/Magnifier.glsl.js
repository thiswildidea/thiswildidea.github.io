...
//>>built
define("exports ../../../../core/screenUtils ../../../../chunks/vec4 ../../../../chunks/vec4f64 ../core/shaderModules/BooleanPassUniform ../core/shaderModules/Float4PassUniform ../core/shaderModules/interfaces ../core/shaderModules/ShaderBuilder ../core/shaderModules/Texture2DPassUniform ../lib/VertexAttribute".split(" "),function(e,f,p,q,k,r,g,t,h,u){class l{}class v extends g.NoParameters{constructor(){super(...arguments);this.textures=new l}}const m=f.createScreenPointArray(),w=f.createRenderScreenPointArray(),
x=q.create();e.MagnifierPassParameters=v;e.TextureResources=l;e.build=function(){const b=new t.ShaderBuilder;b.attributes.add(u.VertexAttribute.POSITION,"vec2");b.vertex.uniforms.add(new r.Float4PassUniform("drawPosition",(a,c)=>{var d=c.camera.pixelRatio;const y=a.magnifier.offset.x*d,z=a.magnifier.offset.y*d;f.screenPointObjectToArray(a.magnifier.position,m);const n=c.camera.screenToRender(m,w);a=Math.ceil(d*a.magnifier.size);d=c.camera.fullWidth;c=c.camera.fullHeight;return p.set(x,-1+(n[0]+y)/
d*2,-1+(n[1]-z)/c*2,a/d*2,a/c*2)}));b.varyings.add("vUV","vec2");b.vertex.code.add(g.glsl`void main(void) {
vUV = position;
