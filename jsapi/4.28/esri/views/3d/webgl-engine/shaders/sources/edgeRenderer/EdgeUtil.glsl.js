...
"float",2*m.maxElevationOffset);b.code.add(e.glsl`vec2 _componentTextureCoords(float componentIndex, float fieldOffset) {
...
}`):(b.uniforms.add(new l.Matrix3DrawUniform("transformNormalGlobalFromModel",c=>c.transformNormalGlobalFromModel)),b.code.add(e.glsl`vec3 _modelToWorldNormal(vec3 normal) {
...
}`):(b.include(n.DoublePrecision,f),b.uniforms.add(new r.Matrix3PassUniform("transformViewFromCameraRelativeRS",c=>c.transformViewFromCameraRelativeRS),new l.Matrix3DrawUniform("transformWorldFromModelRS",c=>c.transformWorldFromModelRS),new h.Float3DrawUniform("transformWorldFromModelTL",c=>c.transformWorldFromModelTL),new h.Float3DrawUniform("transformWorldFromModelTH",c=>c.transformWorldFromModelTH),new k.Float3PassUniform("transformWorldFromViewTL",c=>c.transformWorldFromViewTL),new k.Float3PassUniform("transformWorldFromViewTH",
