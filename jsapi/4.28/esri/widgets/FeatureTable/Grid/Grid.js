...
//>>built
define("../../../chunks/tslib.es6 ../../../core/arrayUtils ../../../core/events ../../../core/maybe ../../../core/reactiveUtils ../../../core/accessorSupport/decorators/property ../../../core/accessorSupport/decorators/cast ../../../core/has ../../../core/accessorSupport/decorators/subclass ../../Widget ./GridViewModel ../../support/globalCss ../../support/widgetUtils ../../support/decorators/messageBundle ../../support/jsxFactory".split(" "),function(y,$d,Ia,$b,Ja,z,ae,mg,be,ce,de,ee,fe,ge,Y){function ac(b){requestAnimationFrame(function(){bc?
bc(b):(hb||(hb=new Promise(a=>{ib=a}),"complete"===document.readyState?ib():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&ib()})),hb.then(function(){b&&b()}))})}function jb(b,a){for(let c in a)null===c?b.style.removeProperty(c):b.style.setProperty(c,a[c])}function cc(b,a){return(b=window.getComputedStyle(b).getPropertyValue(a))?b.trim():""}function dc(b){kb=b&&b.shimcssproperties?!1:Ka||!(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/)||!window.CSS||!CSS.supports||
!CSS.supports("box-shadow","0 0 0 var(--foo)"))}function ka(b,a){if(b&&he.test(b)||"//"===b)return b;if(void 0===La){La=!1;try{const c=new URL("b","http://a");c.pathname="c%20d";La="http://a/c%20d"===c.href}catch(c){}}a||(a=document.baseURI||window.location.href);if(La)try{return(new URL(b,a)).href}catch(c){return b}D||(D=document.implementation.createHTMLDocument("temp"),D.base=D.createElement("base"),D.head.appendChild(D.base),D.anchor=D.createElement("a"),D.body.appendChild(D.anchor));D.base.href=
a;D.anchor.href=b;return D.anchor.href||b}function lb(b,a){return b.replace(ie,function(c,d,e,f){return d+"'"+ka(e.replace(/["']/g,""),a)+"'"+f})}function mb(b){return b.substring(0,b.lastIndexOf("/")+1)}function ec(b){b=lb((b.body?b.body:b).textContent,b.baseURI);const a=document.createElement("style");a.textContent=b;return a}function je(b){b=b.trim().split(/\s+/);const a=[];for(let g=0;g<b.length;g++){var c=a,d=c.push,e;var f=b[g];if(e=O.import(f)){if(void 0===e._styles){f=[];f.push(...nb(e));
const h=e.querySelector("template");h&&f.push(...ob(h,e.assetpath));e._styles=f}e=e._styles}else console.warn("Could not find style data in module named",f),e=[];d.call(c,...e)}return a}function ob(b,a){if(!b._styles){const c=[],d=b.content.querySelectorAll("style");for(let e=0;e<d.length;e++){let f=d[e],g=f.getAttribute("include");g&&c.push(...je(g).filter(function(h,k,l){return l.indexOf(h)===k}));a&&(f.textContent=lb(f.textContent,a));c.push(f)}b._styles=c}return b._styles}function ke(b){return(b=
O.import(b))?nb(b):[]}function nb(b){const a=[];b=b.querySelectorAll("link[rel\x3dimport][type~\x3dcss]");for(let d=0;d<b.length;d++){var c=b[d];if(c.import){const e=c.import;if((c=c.hasAttribute("shady-unscoped"))&&!e._unscopedStyle){const f=ec(e);f.setAttribute("shady-unscoped","");e._unscopedStyle=f}else e._style||(e._style=ec(e));a.push(c?e._unscopedStyle:e._style)}}return a}function J(b){let a=b.indexOf(".");return-1===a?b:b.slice(0,a)}function la(b){if(Array.isArray(b)){let a=[];for(let c=0;c<
b.length;c++){let d=b[c].toString().split(".");for(let e=0;e<d.length;e++)a.push(d[e])}return a.join(".")}return b}function fc(b){return Array.isArray(b)?la(b).split("."):b.toString().split(".")}function B(b,a,c){a=fc(a);for(let d=0;d<a.length;d++){if(!b)return;b=b[a[d]]}c&&(c.path=a.join("."));return b}function gc(b,a,c){let d=fc(a),e=d[d.length-1];if(1<d.length){for(a=0;a<d.length-1;a++)if(b=b[d[a]],!b)return;b[e]=c}else b[a]=c;return d.join(".")}function hc(b){return Ma[b]||(Ma[b]=0>b.indexOf("-")?
b:b.replace(le,a=>a[1].toUpperCase()))}function Na(b){return Ma[b]||(Ma[b]=b.replace(me,"-$1").toLowerCase())}function ic(b,a){let c=a.parentInfo&&ic(b,a.parentInfo);if(c)for(let d=c.firstChild,e=0;d;d=d.nextSibling){if(a.parentIndex===e++)return d}else return b}function ne(b,a,c){b=b._methodHost||b;return function(d){if(b[c])b[c](d,d.detail);else console.warn("listener method `"+c+"` not defined")}}function pb(b,a,c){let d=b[a];if(!d)d=b[a]={};else if(!b.hasOwnProperty(a)&&(d=b[a]=Object.create(b[a]),
c))for(let e in d)for(b=d[e],a=d[e]=Array(b.length),c=0;c<b.length;c++)a[c]=b[c];return d}function ma(b,a,c,d,e,f){if(a){let h=!1;const k=na++;for(let l in c){var g=e?J(l):l;if(g=a[g])for(let m=0,n=g.length,p;m<n&&(p=g[m]);m++)p.info&&p.info.lastRun===k||e&&!qb(l,p.trigger)||(p.info&&(p.info.lastRun=k),p.fn(b,l,c,d,p.info,e,f),h=!0)}return h}return!1}function qb(b,a){if(a){let c=a.name;return c==b||!(!a.structured||0!==c.indexOf(b+"."))||!(!a.wildcard||0!==b.indexOf(c+"."))}return!0}function jc(b,
a,c,d,e){a="string"===typeof e.method?b[e.method]:e.method;c=e.property;a?a.call(b,b.__data[c],d[c]):e.dynamicFn||console.warn("observer method `"+e.method+"` not defined")}function kc(b,a,c,d){c={value:c,queueProperty:!0};d&&(c.path=d);q(b).dispatchEvent(new CustomEvent(a,{detail:c}))}function oe(b,a,c,d,e,f){f=(d=(f?J(a):a)!=a?a:null)?B(b,d):b.__data[a];d&&void 0===f&&(f=c[a]);kc(b,e.eventName,f,d)}function pe(b,a,c,d,e){c=b.__data[a];Oa&&(c=Oa(c,e.attrName,"attribute",b));b._propertyToAttribute(a,
e.attrName,c)}function qe(b){let a=b.constructor.__orderedComputedDeps;if(!a){a=new Map;const d=b[t.COMPUTE];let {counts:e,ready:f,total:g}=re(b);for(var c;c=f.shift();)a.set(c,a.size),(c=d[c])&&c.forEach(h=>{h=h.info.methodInfo;--g;0===--e[h]&&f.push(h)});0!==g&&console.warn(`Computed graph for ${b.localName} incomplete; circular?`);b.constructor.__orderedComputedDeps=a}return a}function re(b){const a=b.__computeInfo,c={};b=b[t.COMPUTE];const d=[];let e=0;for(let f in a){const g=a[f];e+=c[f]=g.args.filter(h=>
!h.literal).length+(g.dynamicFn?1:0)}for(let f in b)a[f]||d.push(f);return{counts:c,ready:d,total:e}}function lc(b,a,c,d,e){a=rb(b,a,c,d,e);if(a===oa)return!1;e=e.methodInfo;if(b.__dataHasAccessor&&b.__dataHasAccessor[e])return b._setPendingProperty(e,a,!0);b[e]=a;return!1}function sb(b,a,c,d,e,f,g){c.bindings=c.bindings||[];d={kind:d,target:e,parts:f,literal:g,isCompound:1!==f.length};c.bindings.push(d);if(d.target&&"attribute"!=d.kind&&"text"!=d.kind&&!d.isCompound&&"{"===d.parts[0].mode){let {event:n,
negate:p}=d.parts[0];d.listenerEvent=n||Na(e)+"-changed";d.listenerNegate=p}c=a.nodeInfoList.length;for(g=0;g<d.parts.length;g++){var h=d.parts[g];h.compoundIndex=g;e=b;f=a;var k=d,l=h,m=c;if(!l.literal)if("attribute"===k.kind&&"-"===k.target[0])console.warn("Cannot set attribute "+k.target+' because "-" is not a valid attribute starting character');else for(h=l.dependencies,k={index:m,binding:k,part:l,evaluator:e},l=0;l<h.length;l++)m=h[l],"string"==typeof m&&(m=mc(m),m.wildcard=!0),e._addTemplatePropertyEffect(f,
m.rootProperty,{fn:se,info:k,trigger:m})}}function se(b,a,c,d,e,f,g){g=g[e.index];var h=e.binding;let k=e.part;f&&k.source&&a.length>k.source.length&&"property"==h.kind&&!h.isCompound&&g.__isPropertyEffectsClient&&g.__dataHasAccessor&&g.__dataHasAccessor[h.target]?(c=c[a],a=h.target+a.slice(k.source.length),g._setPendingPropertyOrPath(a,c,!1,!0)&&b._enqueueClient(g)):(a=e.evaluator._evaluateBinding(b,k,a,c,d,f),a!==oa&&(h.isCompound&&(c=g.__dataCompoundStorage[h.target],c[k.compoundIndex]=a,a=c.join("")),
"attribute"===h.kind||"textContent"!==h.target&&("value"!==h.target||"input"!==g.localName&&"textarea"!==g.localName)||(a=void 0==a?"":a),Oa&&(a=Oa(a,h.target,h.kind,g)),"attribute"==h.kind?b._valueToNodeAttribute(g,a,h.target):(h=h.target,g.__isPropertyEffectsClient&&g.__dataHasAccessor&&g.__dataHasAccessor[h]?g[t.READ_ONLY]&&g[t.READ_ONLY][h]||g._setPendingProperty(h,a)&&b._enqueueClient(g):b._setUnmanagedPropertyToNode(g,h,a))))}function te(b,a,c){if(c.listenerEvent){let d=c.parts[0];b.addEventListener(c.listenerEvent,
function(e){var f=c.target,g=d.source,h=d.negate;let k=e.detail,l=k&&k.path;l?(g+=l.slice(f.length),e=k&&k.value):e=e.currentTarget[f];a[t.READ_ONLY]&&a[t.READ_ONLY][g]||!a._setPendingPropertyOrPath(g,h?!e:e,!0,!!l)||k&&k.queueProperty||a._invalidateProperties()})}}function nc(b,a,c,d,e,f){f=a.static||f&&("object"!==typeof f||f[a.methodName]);e={methodName:a.methodName,args:a.args,methodInfo:e,dynamicFn:f};for(let g=0,h;g<a.args.length&&(h=a.args[g]);g++)h.literal||b._addPropertyEffect(h.rootProperty,
c,{fn:d,info:e,trigger:h});f&&b._addPropertyEffect(a.methodName,c,{fn:d,info:e});return e}function rb(b,a,c,d,e){d=b._methodHost||b;let f=d[e.methodName];if(f)return b=b._marshalArgs(e.args,a,c),b===oa?oa:f.apply(d,b);e.dynamicFn||console.warn("method `"+e.methodName+"` not defined")}function oc(b){let a="";for(let c=0;c<b.length;c++)a+=b[c].literal||"";return a}function tb(b){var a=b.match(/([^\s]+?)\(([\s\S]*)\)/);return a?(b={methodName:a[1],static:!0,args:ue},a[2].trim()?(a=a[2].replace(/\\,/g,
"\x26comma;").split(","),ve(a,b)):b):null}function ve(b,a){a.args=b.map(function(c){c=mc(c);c.literal||(a.static=!1);return c},this);return a}function mc(b){b=b.trim().replace(/&comma;/g,",").replace(/\\(.)/g,"$1");let a={name:b,value:"",literal:!1},c=b[0];"-"===c&&(c=b[1]);"0"<=c&&"9">=c&&(c="#");switch(c){case "'":case '"':a.value=b.slice(1,-1);a.literal=!0;break;case "#":a.value=Number(b),a.literal=!0}a.literal||(a.rootProperty=J(b),a.structured=0<=b.indexOf("."),a.structured&&(a.wildcard=".*"==
b.slice(-2),a.wildcard&&(a.name=b.slice(0,-2))));return a}function pc(b,a,c){b=B(b,c);void 0===b&&(b=a[c]);return b}function qc(b,a,c,d){d={indexSplices:d};ub&&!b._overrideLegacyUndefined&&(a.splices=d);b.notifyPath(c+".splices",d);b.notifyPath(c+".length",a.length);ub&&!b._overrideLegacyUndefined&&(d.indexSplices=[])}function pa(b,a,c,d,e,f){qc(b,a,c,[{index:d,addedCount:e,removed:f,object:a,type:"splice"}])}function we(b){return b[0].toUpperCase()+b.substring(1)}function rc(b){if(!(-1<Pa.indexOf(b))&&
"touchend"!==b&&vb&&wb&&xe)return{passive:!0}}function sc(b){let a=tc?["click"]:Pa;for(let c=0,d;c<a.length;c++)d=a[c],b?(xb.length=0,document.addEventListener(d,uc,!0)):document.removeEventListener(d,uc,!0)}function Z(b){var a=b.type;return-1<Pa.indexOf(a)?"mousemove"===a?(a=void 0===b.buttons?1:b.buttons,b instanceof window.MouseEvent&&!ye&&(a=ze[b.which]||0),!!(a&1)):0===(void 0===b.button?0:b.button):!1}function Ae(b){if("click"===b.type){if(0===b.detail)return!0;var a=P(b);if(!a.nodeType||a.nodeType!==
Node.ELEMENT_NODE)return!0;a=a.getBoundingClientRect();let c=b.pageX;b=b.pageY;return!(c>=a.left&&c<=a.right&&b>=a.top&&b<=a.bottom)}return!1}function vc(b,a,c){b.movefn=a;b.upfn=c;document.addEventListener("mousemove",a);document.addEventListener("mouseup",c)}function ba(b){document.removeEventListener("mousemove",b.movefn);document.removeEventListener("mouseup",b.upfn);b.movefn=null;b.upfn=null}function P(b){const a=Qa(b);return 0<a.length?a[0]:b.target}function wc(b){let a=b.type;var c=b.currentTarget.__polymerGestures;
if(c&&(c=c[a])){if(!b.__polymerGesturesHandled&&(b.__polymerGesturesHandled={},"touch"===a.slice(0,5))){var d=b.changedTouches[0];"touchstart"===a&&1===b.touches.length&&(A.touch.id=d.identifier);if(A.touch.id!==d.identifier)return;if(!vb&&("touchstart"===a||"touchmove"===a)){d=b.changedTouches[0];var e=b.type;if("touchstart"===e)A.touch.x=d.clientX,A.touch.y=d.clientY,A.touch.scrollDecided=!1;else if("touchmove"===e&&!A.touch.scrollDecided){A.touch.scrollDecided=!0;e="auto";var f=Qa(b);for(let h=
0,k;h<f.length;h++)if(k=f[h],k.__polymerGesturesTouchAction){e=k.__polymerGesturesTouchAction;break}f=!1;var g=Math.abs(A.touch.x-d.clientX);d=Math.abs(A.touch.y-d.clientY);b.cancelable&&("none"===e?f=!0:"pan-x"===e?f=d>g:"pan-y"===e&&(f=g>d));f?b.preventDefault():Ra("track")}}}d=b.__polymerGesturesHandled;if(!d.skip){for(let h=0,k;h<aa.length;h++)k=aa[h],c[k.name]&&!d[k.name]&&k.flow&&-1<k.flow.start.indexOf(b.type)&&k.reset&&k.reset();for(let h=0,k;h<aa.length;h++)k=aa[h],c[k.name]&&!d[k.name]&&
(d[k.name]=!0,k[a](b))}}}function yb(b,a,c){if(qa[a]){let d=qa[a],e=d.deps,f=d.name,g=b.__polymerGestures;g||(b.__polymerGestures=g={});for(let h=0,k,l;h<e.length;h++)k=e[h],tc&&-1<Pa.indexOf(k)&&"click"!==k||((l=g[k])||(g[k]=l={_count:0}),0===l._count&&b.addEventListener(k,wc,rc(k)),l[f]=(l[f]||0)+1,l._count=(l._count||0)+1);b.addEventListener(a,c);d.touchAction&&xc(b,d.touchAction);return!0}return!1}function zb(b){aa.push(b);for(let a=0;a<b.emits.length;a++)qa[b.emits[a]]=b}function xc(b,a){vb&&
b instanceof HTMLElement&&F.run(()=>{b.style.touchAction=a});b.__polymerGesturesTouchAction=a}function Ab(b,a,c){a=new Event(a,{bubbles:!0,cancelable:!0,composed:!0});a.detail=c;q(b).dispatchEvent(a);a.defaultPrevented&&(b=c.preventer||c.sourceEvent)&&b.preventDefault&&b.preventDefault()}function Ra(b){a:{for(let a=0,c;a<aa.length;a++){c=aa[a];for(let d=0,e;d<c.emits.length;d++)if(e=c.emits[d],e===b){b=c;break a}}b=null}b.info&&(b.info.prevent=!0)}function ra(b,a,c,d){a&&Ab(a,b,{x:c.clientX,y:c.clientY,
sourceEvent:c,preventer:d,prevent:function(e){return Ra(e)}})}function yc(b,a,c){if(b.prevent)return!1;if(b.started)return!0;c=Math.abs(b.y-c);return 5<=Math.abs(b.x-a)||5<=c}function Bb(b,a,c){if(a){var d=b.moves[b.moves.length-2],e=b.moves[b.moves.length-1],f=e.x-b.x,g=e.y-b.y,h=0;if(d){var k=e.x-d.x;h=e.y-d.y}Ab(a,"track",{state:b.state,x:c.clientX,y:c.clientY,dx:f,dy:g,ddx:k,ddy:h,sourceEvent:c,hover:function(){var l=c.clientX,m=c.clientY;let n=document.elementFromPoint(l,m),p=n;for(;p&&p.shadowRoot&&
!window.ShadyDOM;){let r=p;p=p.shadowRoot.elementFromPoint(l,m);if(r===p)break;p&&(n=p)}return n}})}}function zc(b,a,c){let d=Math.abs(a.clientX-b.x),e=Math.abs(a.clientY-b.y),f=P(c||a);!f||Be[f.localName]&&f.hasAttribute("disabled")||!(isNaN(d)||isNaN(e)||25>=d&&25>=e||Ae(a))||b.prevent||Ab(f,"tap",{x:a.clientX,y:a.clientY,sourceEvent:a,preventer:c})}function Ce(){return Ac(function(){return!0})}function De(){return Sa&&0<Object.keys(Sa).map(b=>Sa[b]).filter(b=>b.productionMode).length?!0:!1}function Ac(b,
a){if("function"===typeof b){var c=Ee.exec(b.toString());if(c)try{b=new Function(c[1])}catch(d){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",d)}return b(a)}}function Fe(){}function Bc(){Ta=!0;requestAnimationFrame(function(){Ta=!1;Ge(Cc);setTimeout(function(){var b=Dc;for(let a=0,c=b.length;a<c;a++)Ec(b.shift())})})}function Ge(b){for(;b.length;)Ec(b.shift())}function Ec(b){const a=b[0],c=b[1];b=b[2];try{c.apply(a,b)}catch(d){setTimeout(()=>{throw d;})}}function He(b,a,
c){Ta||Bc();Cc.push([b,a,c])}function Ie(b,a,c){Ta||Bc();Dc.push([b,a,c])}function Fc(b){b=b.replace(K.comments,"").replace(K.port,"");var a=Gc,c=b;let d=new Hc;d.start=0;d.end=c.length;let e=d;for(let f=0,g=c.length;f<g;f++)if("{"===c[f]){e.rules||(e.rules=[]);let h=e,k=h.rules[h.rules.length-1]||null;e=new Hc;e.start=f+1;e.parent=h;e.previous=k;h.rules.push(e)}else"}"===c[f]&&(e.end=f+1,e=e.parent||d);return a(d,b)}function Gc(b,a){var c=a.substring(b.start,b.end-1);b.parsedCssText=b.cssText=c.trim();
b.parent&&(c=a.substring(b.previous?b.previous.end:b.parent.start,b.start-1),c=Je(c),c=c.replace(K.multipleSpaces," "),c=c.substring(c.lastIndexOf(";")+1),c=b.parsedSelector=b.selector=c.trim(),b.atRule=0===c.indexOf("@"),b.atRule?0===c.indexOf("@media")?b.type=Q.MEDIA_RULE:c.match(K.keyframesRule)&&(b.type=Q.KEYFRAMES_RULE,b.keyframesName=b.selector.split(K.multipleSpaces).pop()):0===c.indexOf("--")?b.type=Q.MIXIN_RULE:b.type=Q.STYLE_RULE);if(c=b.rules)for(let d=0,e=c.length,f;d<e&&(f=c[d]);d++)Gc(f,
a);return b}function Je(b){return b.replace(/\\([0-9a-f]{1,6})\s/gi,function(a,c){a=c;for(c=6-a.length;c--;)a="0"+a;return"\\"+a})}function Ic(b,a,c=""){let d="";if(b.cssText||b.rules){let f=b.rules;var e;if(e=f)e=f[0],e=!(e&&e.selector&&0===e.selector.indexOf("--"));if(e)for(let g=0,h=f.length,k;g<h&&(k=f[g]);g++)d=Ic(k,a,d);else a?a=b.cssText:(a=b.cssText,a=a.replace(K.customProp,"").replace(K.mixinProp,""),a=a.replace(K.mixinApply,"").replace(K.varApply,"")),(d=a.trim())&&(d="  "+d+"\n")}d&&(b.selector&&
(c+=b.selector+" {\n"),c+=d,b.selector&&(c+="}\n\n"));return c}function Cb(b,a){if(!b)return"";"string"===typeof b&&(b=Fc(b));a&&sa(b,a);return Ic(b,Db)}function Jc(b){!b.__cssRules&&b.textContent&&(b.__cssRules=Fc(b.textContent));return b.__cssRules||null}function sa(b,a,c,d){if(b){var e=!1,f=b.type;if(d&&f===Q.MEDIA_RULE){let g=b.selector.match(Ke);g&&(window.matchMedia(g[1]).matches||(e=!0))}f===Q.STYLE_RULE?a(b):c&&f===Q.KEYFRAMES_RULE?c(b):f===Q.MIXIN_RULE&&(e=!0);if((b=b.rules)&&!e)for(let g=
0,h=b.length,k;g<h&&(k=b[g]);g++)sa(k,a,c,d)}}function Kc(b,a){var c=b.indexOf("var(");if(-1===c)return a(b,"","","");a:{var d=0;for(let g=c+3,h=b.length;g<h;g++)if("("===b[g])d++;else if(")"===b[g]&&0===--d){d=g;break a}d=-1}var e=d;d=b.substring(c+4,e);c=b.substring(0,c);b=Kc(b.substring(e+1),a);let f=d.indexOf(",");if(-1===f)return a(c,d.trim(),"",b);e=d.substring(0,f).trim();d=d.substring(f+1).trim();return a(c,e,d,b)}function Lc(b){if(void 0!==ta)return ta;if(void 0===b.__cssBuild){var a=b.getAttribute("css-build");
if(a)b.__cssBuild=a;else{a:{a="template"===b.localName?b.content.firstChild:b.firstChild;if(a instanceof Comment&&(a=a.textContent.trim().split(":"),"css-build"===a[0])){a=a[1];break a}a=""}if(""!==a){const c="template"===b.localName?b.content.firstChild:b.firstChild;c.parentNode.removeChild(c)}b.__cssBuild=a}}return b.__cssBuild||""}function Le(b){if(b=Eb[b])b._applyShimCurrentVersion=b._applyShimCurrentVersion||0,b._applyShimValidatingVersion=b._applyShimValidatingVersion||0,b._applyShimNextVersion=
(b._applyShimNextVersion||0)+1}function Mc(b){return b._applyShimCurrentVersion===b._applyShimNextVersion}function Me(b){b._applyShimValidatingVersion=b._applyShimNextVersion;b._validating||(b._validating=!0,Ne.then(function(){b._applyShimCurrentVersion=b._applyShimNextVersion;b._validating=!1}))}function Nc(){ua=document.documentElement.getAttribute("dir");ua=document.documentElement.getAttribute("dir");for(let a=0;a<va.length;a++){var b=va[a];b.__autoDirOptOut||b.setAttribute("dir",ua)}}function Oc(){document.body.removeAttribute("unresolved")}
function wa(b,a,c){return{index:b,removed:a,addedCount:c}}function Pc(b,a,c,d,e,f){var g=0,h=0,k=Math.min(c-a,f-e);if(0==a&&0==e)a:{for(g=0;g<k;g++)if(b[g]!==d[g])break a;g=k}if(c==b.length&&f==d.length){h=k-g;k=b.length;for(var l=d.length,m=0;m<h&&Oe(b[--k],d[--l]);)m++;h=m}a+=g;e+=g;c-=h;f-=h;if(0==c-a&&0==f-e)return[];if(a==c){for(c=wa(a,[],0);e<f;)c.removed.push(d[e++]);return[c]}if(e==f)return[wa(a,[],c-a)];g=a;h=e;f=f-h+1;k=c-g+1;c=Array(f);for(l=0;l<f;l++)c[l]=Array(k),c[l][0]=l;for(l=0;l<
k;l++)c[0][l]=l;for(l=1;l<f;l++)for(m=1;m<k;m++)if(b[g+m-1]===d[h+l-1])c[l][m]=c[l-1][m-1];else{var n=c[l-1][m]+1;let p=c[l][m-1]+1;c[l][m]=n<p?n:p}f=c.length-1;g=c[0].length-1;h=c[f][g];for(b=[];0<f||0<g;)0==f?(b.push(2),g--):0==g?(b.push(3),f--):(k=c[f-1][g-1],l=c[f-1][g],m=c[f][g-1],n=l<m?l<k?l:k:m<k?m:k,n==k?(k==h?b.push(0):(b.push(1),h=k),f--,g--):n==l?(b.push(3),f--,h=l):(b.push(2),g--,h=m));b.reverse();c=void 0;f=[];for(g=0;g<b.length;g++)switch(b[g]){case 0:c&&(f.push(c),c=void 0);a++;e++;
break;case 1:c||(c=wa(a,[],0));c.addedCount++;a++;c.removed.push(d[e]);e++;break;case 2:c||(c=wa(a,[],0));c.addedCount++;a++;break;case 3:c||(c=wa(a,[],0)),c.removed.push(d[e]),e++}c&&f.push(c);return f}function Oe(b,a){return b===a}function ca(b){return"slot"===b.localName}function Pe(b,a){for(let c=0;c<a.length;c++){let d=a[c];b[d]=function(){return this.node[d].apply(this.node,arguments)}}}function Qc(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},
configurable:!0})}}function Qe(b,a){for(let c=0;c<a.length;c++){let d=a[c];Object.defineProperty(b,d,{get:function(){return this.node[d]},set:function(e){this.node[d]=e},configurable:!0})}}function Re(b,a=!1){if(!Fb||!Rc||!Fb.handlesDynamicScoping)return null;const c=Rc.ScopingShim;if(!c)return null;const d=c.scopeForNode(b),e=q(b).getRootNode(),f=g=>{if(q(g).getRootNode()===e){var h=Array.from(Fb.nativeMethods.querySelectorAll.call(g,"*"));h.push(g);for(g=0;g<h.length;g++){const l=h[g];var k=e;q(l).getRootNode()===
k&&(k=c.currentScopeForNode(l),k!==d&&(""!==k&&c.unscopeNode(l,k),c.scopeNode(l,d)))}}};f(b);return a?(a=new MutationObserver(g=>{for(let h=0;h<g.length;h++){const k=g[h];for(let l=0;l<k.addedNodes.length;l++){const m=k.addedNodes[l];m.nodeType===Node.ELEMENT_NODE&&f(m)}}}),a.observe(b,{childList:!0,subtree:!0}),a):null}function Sc(b,a,c,d){const e=a._noAccessors,f=Object.getOwnPropertyNames(a);for(let g=0;g<f.length;g++){let h=f[g];if(!(h in d))if(e)b[h]=a[h];else{let k=Object.getOwnPropertyDescriptor(a,
h);k&&(k.configurable=!0,Object.defineProperty(b,h,k))}}for(let g in Se)a[g]&&(c[g]=c[g]||[],c[g].push(a[g]))}function Tc(b,a,c){a=a||[];for(let d=b.length-1;0<=d;d--){let e=b[d];e?Array.isArray(e)?Tc(e,a):0>a.indexOf(e)&&(!c||0>c.indexOf(e))&&a.unshift(e):console.warn("behavior is null, check for missing or 404 import")}return a}function Uc(b,a){for(const c in a){const d=b[c],e=a[c];b[c]=!("value"in e)&&d&&"value"in d?Object.assign({value:d.value},e):e}}function Te(b,a,c){let d;const e={};class f extends a{static _finalizeClass(){if(this.hasOwnProperty("generatedFrom")){if(d)for(let h=
0,k;h<d.length;h++)k=d[h],k.properties&&this.createProperties(k.properties),k.observers&&this.createObservers(k.observers,k.properties);b.properties&&this.createProperties(b.properties);b.observers&&this.createObservers(b.observers,b.properties);this._prepareTemplate()}else a._finalizeClass.call(this)}static get properties(){const h={};if(d)for(let k=0;k<d.length;k++)Uc(h,d[k].properties);Uc(h,b.properties);return h}static get observers(){let h=[];if(d)for(let k=0,l;k<d.length;k++)l=d[k],l.observers&&
(h=h.concat(l.observers));b.observers&&(h=h.concat(b.observers));return h}created(){super.created();const h=e.created;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}_registered(){var h=f.prototype;if(!h.hasOwnProperty("__hasRegisterFinished")){h.__hasRegisterFinished=!0;super._registered();xa&&g(h);h=Object.getPrototypeOf(this);let l=e.beforeRegister;if(l)for(var k=0;k<l.length;k++)l[k].call(h);if(l=e.registered)for(k=0;k<l.length;k++)l[k].call(h)}}_applyListeners(){super._applyListeners();const h=
e.listeners;if(h)for(let k=0;k<h.length;k++){const l=h[k];if(l)for(let m in l)this._addMethodEventListenerToNode(this,m,l[m])}}_ensureAttributes(){const h=e.hostAttributes;if(h)for(let k=h.length-1;0<=k;k--){const l=h[k];for(let m in l)this._ensureAttribute(m,l[m])}super._ensureAttributes()}ready(){super.ready();let h=e.ready;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}attached(){super.attached();let h=e.attached;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}detached(){super.detached();let h=
e.detached;if(h)for(let k=0;k<h.length;k++)h[k].call(this)}attributeChanged(h,k,l){super.attributeChanged();let m=e.attributeChanged;if(m)for(let n=0;n<m.length;n++)m[n].call(this,h,k,l)}}if(c){Array.isArray(c)||(c=[c]);let h=a.prototype.behaviors;d=Tc(c,null,h);f.prototype.behaviors=h?h.concat(c):d}const g=h=>{if(d){var k=d;for(let l=0;l<k.length;l++)Sc(h,k[l],e,Ue)}Sc(h,b,e,Vc)};xa||g(f.prototype);f.generatedFrom=b;return f}function Gb(b,a,c,d,e){let f;e&&(f="object"===typeof c&&null!==c)&&(d=b.__dataTemp[a]);
d=d!==c&&(d===d||c===c);f&&d&&(b.__dataTemp[a]=c);return d}function Hb(){return Ib}function Wc(b,a){for(let c=0;c<a.length;c++){let d=a[c];if(!!b!=!!d.__hideTemplateChildren__)if(d.nodeType===Node.TEXT_NODE)b?(d.__polymerTextContent__=d.textContent,d.textContent=""):d.textContent=d.__polymerTextContent__;else if("slot"===d.localName)if(b)d.__polymerReplaced__=document.createComment("hidden-slot"),q(q(d).parentNode).replaceChild(d.__polymerReplaced__,d);else{const e=d.__polymerReplaced__;e&&q(q(e).parentNode).replaceChild(d,
e)}else d.style&&(b?(d.__polymerDisplay__=d.style.display,d.style.display="none"):d.style.display=d.__polymerDisplay__);d.__hideTemplateChildren__=b;d._showHideChildren&&d._showHideChildren(b)}}function Xc(b){return(b=b.__dataHost)&&b._methodHost||b}function Ve(b,a){return function(c,d,e){a.call(c.__templatizeOwner,d.substring(6),e[d])}}function We(b,a){return function(c,d,e){a.call(c.__templatizeOwner,c,d,e[d])}}function Xe(){return function(b,a,c){b.__dataHost._setPendingPropertyOrPath("_host_"+
a,c[a],!0,!0)}}function ya(b,a,c){if(da&&!Xc(b))throw Error("strictTemplatePolicy: template owner not trusted");c=c||{};if(b.__templatizeOwner)throw Error("A \x3ctemplate\x3e can only be templatized once");b.__templatizeOwner=a;let d=(a?a.constructor:R)._parseTemplate(b);var e=d.templatizeInstanceClass;if(!e){e=c;var f=e.mutableData?Ye:R;ya.mixin&&(f=ya.mixin(f));var g=class extends f{};g.prototype.__templatizeOptions=e;g.prototype._bindTemplate(b);f=g;var h=d.hostProps||{};for(var k in e.instanceProps){delete h[k];
var l=e.notifyInstanceProp;l&&f.prototype._addPropertyEffect(k,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:We(k,l)})}if(e.forwardHostProp&&b.__dataHost)for(var m in h)d.hasHostProps||(d.hasHostProps=!0),f.prototype._addPropertyEffect(m,f.prototype.PROPERTY_EFFECT_TYPES.NOTIFY,{fn:Xe()});e=g;d.templatizeInstanceClass=e}k=Xc(b);f=c;if((g=f.forwardHostProp)&&d.hasHostProps){c="template"==b.localName;m=d.templatizeTemplateClass;if(!m){if(c){m=f.mutableData?Ze:Yc;class v extends m{}m=d.templatizeTemplateClass=
v}else{m=b.constructor;class v extends m{}m=d.templatizeTemplateClass=v}h=d.hostProps;for(var n in h)m.prototype._addPropertyEffect("_host_"+n,m.prototype.PROPERTY_EFFECT_TYPES.PROPAGATE,{fn:Ve(n,g)}),m.prototype._createNotifyingProperty("_host_"+n);if(Zc&&k){n=k.constructor._properties;({propertyEffects:g}=d);({instanceProps:f}=f);for(var p in g)if(!(n[p]||f&&f[p]))for(h=g[p],l=0;l<h.length;l++){const {part:v}=h[l].info;if(!v.signature||!v.signature.static){console.warn(`Property '${p}' used in template but not `+
"declared in 'properties'; attribute will not be observed.");break}}}}b.__dataProto&&Object.assign(b.__data,b.__dataProto);if(c){var r=m;Ib=b;Object.setPrototypeOf(b,r.prototype);new r;Ib=null;b.__dataTemp={};b.__dataPending=null;b.__dataOld=null;b._enableProperties()}else for(r in Object.setPrototypeOf(b,m.prototype),p=d.hostProps,p)r="_host_"+r,r in b&&(p=b[r],delete b[r],b.__data[r]=p)}r=class extends e{};r.prototype._methodHost=k;r.prototype.__dataHost=b;r.prototype.__templatizeOwner=a;r.prototype.__hostProps=
d.hostProps;return r}function Jb(){if(xa&&!Kb){if(!$c){$c=!0;const b=document.createElement("style");b.textContent="dom-bind,dom-if,dom-repeat{display:none;}";document.head.appendChild(b)}return!0}return!1}class $e extends HTMLElement{static get version(){return"1.6.1"}}customElements.define("vaadin-lumo-styles",$e);let hb=null,bc=window.HTMLImports&&window.HTMLImports.whenReady||null,ib,Ua=null,za=null;class S{constructor(){this.customStyles=[];this.enqueued=!1;ac(()=>{window.ShadyCSS.flushCustomStyles&&
window.ShadyCSS.flushCustomStyles()})}enqueueDocumentValidation(){!this.enqueued&&za&&(this.enqueued=!0,ac(za))}addCustomStyle(b){b.__seenByShadyCSS||(b.__seenByShadyCSS=!0,this.customStyles.push(b),this.enqueueDocumentValidation())}getStyleForCustomStyle(b){return b.__shadyCSSCachedStyle?b.__shadyCSSCachedStyle:b.getStyle?b.getStyle():b}processStyles(){const b=this.customStyles;for(let c=0;c<b.length;c++){const d=b[c];if(!d.__shadyCSSCachedStyle){var a=this.getStyleForCustomStyle(d);a&&(a=a.__appliedElement||
a,Ua&&Ua(a),d.__shadyCSSCachedStyle=a)}}return b}}S.prototype.addCustomStyle=S.prototype.addCustomStyle;S.prototype.getStyleForCustomStyle=S.prototype.getStyleForCustomStyle;S.prototype.processStyles=S.prototype.processStyles;Object.defineProperties(S.prototype,{transformCallback:{get(){return Ua},set(b){Ua=b}},validateCallback:{get(){return za},set(b){let a=!1;za||(a=!0);za=b;a&&this.enqueueDocumentValidation()}}});const Lb=/(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gi,
Va=/(?:^|\W+)@apply\s*\(?([^);\n]*)\)?/gi,Ke=/@media\s(.*)/,Ka=!(window.ShadyDOM&&window.ShadyDOM.inUse);let kb,ta;window.ShadyCSS&&void 0!==window.ShadyCSS.cssBuild&&(ta=window.ShadyCSS.cssBuild);const ad=!(!window.ShadyCSS||!window.ShadyCSS.disableRuntime);window.ShadyCSS&&void 0!==window.ShadyCSS.nativeCss?kb=window.ShadyCSS.nativeCss:window.ShadyCSS?(dc(window.ShadyCSS),window.ShadyCSS=void 0):dc(window.WebComponents&&window.WebComponents.flags);const Db=kb,Wa=new S;window.ShadyCSS||(window.ShadyCSS=
{prepareTemplate(b,a,c){},prepareTemplateDom(b,a){},prepareTemplateStyles(b,a,c){},styleSubtree(b,a){Wa.processStyles();jb(b,a)},styleElement(b){Wa.processStyles()},styleDocument(b){Wa.processStyles();jb(document.body,b)},getComputedStyleValue(b,a){return cc(b,a)},flushCustomStyles(){},nativeCss:Db,nativeShadow:Ka,cssBuild:ta,disableRuntime:ad});window.ShadyCSS.CustomStyleInterface=Wa;window.JSCompiler_renameProperty=function(b,a){return b};let ie=/(url\()([^)]*)(\))/g,he=/(^\/[^\/])|(^#)|(^[\w-\d]*:)/,
La,D;const Kb=!window.ShadyDOM||!window.ShadyDOM.inUse;!(window.ShadyCSS&&!window.ShadyCSS.nativeCss);const af=Kb&&"adoptedStyleSheets"in Document.prototype&&"replaceSync"in CSSStyleSheet.prototype&&(()=>{try{const b=new CSSStyleSheet;b.replaceSync("");const a=document.createElement("div");a.attachShadow({mode:"open"});a.shadowRoot.adoptedStyleSheets=[b];return a.shadowRoot.adoptedStyleSheets[0]===b}catch(b){return!1}})();let bf=window.Polymer&&window.Polymer.rootPath||mb(document.baseURI||window.location.href),
Oa=window.Polymer&&window.Polymer.sanitizeDOMValue||void 0,xe=window.Polymer&&window.Polymer.setPassiveTouchGestures||!1,da=window.Polymer&&window.Polymer.strictTemplatePolicy||!1,cf=window.Polymer&&window.Polymer.allowTemplateFromDomModule||!1,xa=window.Polymer&&window.Polymer.legacyOptimizations||!1,Zc=window.Polymer&&window.Polymer.legacyWarnings||!1,df=window.Polymer&&window.Polymer.syncInitialRender||!1,ub=window.Polymer&&window.Polymer.legacyUndefined||!1,ef=window.Polymer&&window.Polymer.orderedComputed||
!1,bd=window.Polymer&&window.Polymer.removeNestedTemplates||!1,cd=window.Polymer&&window.Polymer.fastDomIf||!1,Mb=window.Polymer&&window.Polymer.suppressTemplateNotifications||!1,Xa=window.Polymer&&window.Polymer.legacyNoObservedAttributes||!1,ff=window.Polymer&&window.Polymer.useAdoptedStyleSheetsWithBuiltCSS||!1,Aa={},Ya={};class O extends HTMLElement{static get observedAttributes(){return["id"]}static import(b,a){return b?(b=Aa[b]||Ya[b.toLowerCase()])&&a?b.querySelector(a):b:null}attributeChangedCallback(b,
a,c,d){a!==c&&this.register()}get assetpath(){if(!this.__assetpath){var b=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument;b=ka(this.getAttribute("assetpath")||"",b.baseURI);this.__assetpath=mb(b)}return this.__assetpath}register(b){if(b=b||this.id){if(da&&void 0!==(Aa[b]||Ya[b.toLowerCase()]))throw Aa[b]=Ya[b.toLowerCase()]=null,Error(`strictTemplatePolicy: dom-module ${b} re-registered`);this.id=b;Aa[b]=Ya[b.toLowerCase()]=this;this.querySelector("style")&&
console.warn("dom-module %s has style outside template",this.id)}}}O.prototype.modules=Aa;customElements.define("dom-module",O);const gf=window.ShadyCSS.CustomStyleInterface;class hf extends HTMLElement{constructor(){super();this._style=null;gf.addCustomStyle(this)}getStyle(){if(this._style)return this._style;const b=this.querySelector("style");if(!b)return null;this._style=b;var a=b.getAttribute("include");if(a){b.removeAttribute("include");a=a.trim().split(/\s+/);var c="";for(let h=0;h<a.length;h++){var d=
void 0,e=void 0,f=a[h];let k=O.import(f);if(k&&void 0===k._cssText){e="";d=nb(k);for(var g=0;g<d.length;g++)e+=d[g].textContent;if(g=k.querySelector("template")){d="";g=ob(g,k.assetpath);for(let l=0;l<g.length;l++){let m=g[l];m.parentNode&&m.parentNode.removeChild(m);d+=m.textContent}e+=d}k._cssText=e||null}k||console.warn("Could not find style data in module named",f);c+=k&&k._cssText||""}b.textContent=c+b.textContent}this.ownerDocument!==window.document&&window.document.head.appendChild(this);return this._style}}
window.customElements.define("custom-style",hf);const dd=document.createElement("template");dd.innerHTML='\x3ccustom-style\x3e\n  \x3cstyle\x3e\n    html {\n      /* Base (background) */\n      --lumo-base-color: #FFF;\n\n      /* Tint */\n      --lumo-tint-5pct: hsla(0, 0%, 100%, 0.3);\n      --lumo-tint-10pct: hsla(0, 0%, 100%, 0.37);\n      --lumo-tint-20pct: hsla(0, 0%, 100%, 0.44);\n      --lumo-tint-30pct: hsla(0, 0%, 100%, 0.5);\n      --lumo-tint-40pct: hsla(0, 0%, 100%, 0.57);\n      --lumo-tint-50pct: hsla(0, 0%, 100%, 0.64);\n      --lumo-tint-60pct: hsla(0, 0%, 100%, 0.7);\n      --lumo-tint-70pct: hsla(0, 0%, 100%, 0.77);\n      --lumo-tint-80pct: hsla(0, 0%, 100%, 0.84);\n      --lumo-tint-90pct: hsla(0, 0%, 100%, 0.9);\n      --lumo-tint: #FFF;\n\n      /* Shade */\n      --lumo-shade-5pct: hsla(214, 61%, 25%, 0.05);\n      --lumo-shade-10pct: hsla(214, 57%, 24%, 0.1);\n      --lumo-shade-20pct: hsla(214, 53%, 23%, 0.16);\n      --lumo-shade-30pct: hsla(214, 50%, 22%, 0.26);\n      --lumo-shade-40pct: hsla(214, 47%, 21%, 0.38);\n      --lumo-shade-50pct: hsla(214, 45%, 20%, 0.5);\n      --lumo-shade-60pct: hsla(214, 43%, 19%, 0.61);\n      --lumo-shade-70pct: hsla(214, 42%, 18%, 0.72);\n      --lumo-shade-80pct: hsla(214, 41%, 17%, 0.83);\n      --lumo-shade-90pct: hsla(214, 40%, 16%, 0.94);\n      --lumo-shade: hsl(214, 35%, 15%);\n\n      /* Contrast */\n      --lumo-contrast-5pct: var(--lumo-shade-5pct);\n      --lumo-contrast-10pct: var(--lumo-shade-10pct);\n      --lumo-contrast-20pct: var(--lumo-shade-20pct);\n      --lumo-contrast-30pct: var(--lumo-shade-30pct);\n      --lumo-contrast-40pct: var(--lumo-shade-40pct);\n      --lumo-contrast-50pct: var(--lumo-shade-50pct);\n      --lumo-contrast-60pct: var(--lumo-shade-60pct);\n      --lumo-contrast-70pct: var(--lumo-shade-70pct);\n      --lumo-contrast-80pct: var(--lumo-shade-80pct);\n      --lumo-contrast-90pct: var(--lumo-shade-90pct);\n      --lumo-contrast: var(--lumo-shade);\n\n      /* Text */\n      --lumo-header-text-color: var(--lumo-contrast);\n      --lumo-body-text-color: var(--lumo-contrast-90pct);\n      --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n      --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n      --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n      /* Primary */\n      --lumo-primary-color: hsl(214, 90%, 52%);\n      --lumo-primary-color-50pct: hsla(214, 90%, 52%, 0.5);\n      --lumo-primary-color-10pct: hsla(214, 90%, 52%, 0.1);\n      --lumo-primary-text-color: var(--lumo-primary-color);\n      --lumo-primary-contrast-color: #FFF;\n\n      /* Error */\n      --lumo-error-color: hsl(3, 100%, 61%);\n      --lumo-error-color-50pct: hsla(3, 100%, 60%, 0.5);\n      --lumo-error-color-10pct: hsla(3, 100%, 60%, 0.1);\n      --lumo-error-text-color: hsl(3, 92%, 53%);\n      --lumo-error-contrast-color: #FFF;\n\n      /* Success */\n      --lumo-success-color: hsl(145, 80%, 42%); /* hsl(144,82%,37%); */\n      --lumo-success-color-50pct: hsla(145, 76%, 44%, 0.55);\n      --lumo-success-color-10pct: hsla(145, 76%, 44%, 0.12);\n      --lumo-success-text-color: hsl(145, 100%, 32%);\n      --lumo-success-contrast-color: #FFF;\n    }\n  \x3c/style\x3e\n\x3c/custom-style\x3e\x3cdom-module id\x3d"lumo-color"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle\x3e\n      [theme~\x3d"dark"] {\n        /* Base (background) */\n        --lumo-base-color: hsl(214, 35%, 21%);\n\n        /* Tint */\n        --lumo-tint-5pct: hsla(214, 65%, 85%, 0.06);\n        --lumo-tint-10pct: hsla(214, 60%, 80%, 0.14);\n        --lumo-tint-20pct: hsla(214, 64%, 82%, 0.23);\n        --lumo-tint-30pct: hsla(214, 69%, 84%, 0.32);\n        --lumo-tint-40pct: hsla(214, 73%, 86%, 0.41);\n        --lumo-tint-50pct: hsla(214, 78%, 88%, 0.5);\n        --lumo-tint-60pct: hsla(214, 82%, 90%, 0.6);\n        --lumo-tint-70pct: hsla(214, 87%, 92%, 0.7);\n        --lumo-tint-80pct: hsla(214, 91%, 94%, 0.8);\n        --lumo-tint-90pct: hsla(214, 96%, 96%, 0.9);\n        --lumo-tint: hsl(214, 100%, 98%);\n\n        /* Shade */\n        --lumo-shade-5pct: hsla(214, 0%, 0%, 0.07);\n        --lumo-shade-10pct: hsla(214, 4%, 2%, 0.15);\n        --lumo-shade-20pct: hsla(214, 8%, 4%, 0.23);\n        --lumo-shade-30pct: hsla(214, 12%, 6%, 0.32);\n        --lumo-shade-40pct: hsla(214, 16%, 8%, 0.41);\n        --lumo-shade-50pct: hsla(214, 20%, 10%, 0.5);\n        --lumo-shade-60pct: hsla(214, 24%, 12%, 0.6);\n        --lumo-shade-70pct: hsla(214, 28%, 13%, 0.7);\n        --lumo-shade-80pct: hsla(214, 32%, 13%, 0.8);\n        --lumo-shade-90pct: hsla(214, 33%, 13%, 0.9);\n        --lumo-shade: hsl(214, 33%, 13%);\n\n        /* Contrast */\n        --lumo-contrast-5pct: var(--lumo-tint-5pct);\n        --lumo-contrast-10pct: var(--lumo-tint-10pct);\n        --lumo-contrast-20pct: var(--lumo-tint-20pct);\n        --lumo-contrast-30pct: var(--lumo-tint-30pct);\n        --lumo-contrast-40pct: var(--lumo-tint-40pct);\n        --lumo-contrast-50pct: var(--lumo-tint-50pct);\n        --lumo-contrast-60pct: var(--lumo-tint-60pct);\n        --lumo-contrast-70pct: var(--lumo-tint-70pct);\n        --lumo-contrast-80pct: var(--lumo-tint-80pct);\n        --lumo-contrast-90pct: var(--lumo-tint-90pct);\n        --lumo-contrast: var(--lumo-tint);\n\n        /* Text */\n        --lumo-header-text-color: var(--lumo-contrast);\n        --lumo-body-text-color: var(--lumo-contrast-90pct);\n        --lumo-secondary-text-color: var(--lumo-contrast-70pct);\n        --lumo-tertiary-text-color: var(--lumo-contrast-50pct);\n        --lumo-disabled-text-color: var(--lumo-contrast-30pct);\n\n        /* Primary */\n        --lumo-primary-color: hsl(214, 86%, 55%);\n        --lumo-primary-color-50pct: hsla(214, 86%, 55%, 0.5);\n        --lumo-primary-color-10pct: hsla(214, 90%, 63%, 0.1);\n        --lumo-primary-text-color: hsl(214, 100%, 70%);\n        --lumo-primary-contrast-color: #FFF;\n\n        /* Error */\n        --lumo-error-color: hsl(3, 90%, 63%);\n        --lumo-error-color-50pct: hsla(3, 90%, 63%, 0.5);\n        --lumo-error-color-10pct: hsla(3, 90%, 63%, 0.1);\n        --lumo-error-text-color: hsl(3, 100%, 67%);\n\n        /* Success */\n        --lumo-success-color: hsl(145, 65%, 42%);\n        --lumo-success-color-50pct: hsla(145, 65%, 42%, 0.5);\n        --lumo-success-color-10pct: hsla(145, 65%, 42%, 0.1);\n        --lumo-success-text-color: hsl(145, 85%, 47%);\n      }\n\n      html {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      [theme~\x3d"dark"] {\n        color: var(--lumo-body-text-color);\n        background-color: var(--lumo-base-color);\n      }\n\n      h1,\n      h2,\n      h3,\n      h4,\n      h5,\n      h6 {\n        color: var(--lumo-header-text-color);\n      }\n\n      a {\n        color: var(--lumo-primary-text-color);\n      }\n\n      blockquote {\n        color: var(--lumo-secondary-text-color);\n      }\n\n      code,\n      pre {\n        background-color: var(--lumo-contrast-10pct);\n        border-radius: var(--lumo-border-radius-m);\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e\x3cdom-module id\x3d"lumo-color-legacy"\x3e\n  \x3ctemplate\x3e\n    \x3cstyle include\x3d"lumo-color"\x3e\n      :host {\n        color: var(--lumo-body-text-color) !important;\n        background-color: var(--lumo-base-color) !important;\n      }\n    \x3c/style\x3e\n  \x3c/template\x3e\n\x3c/dom-module\x3e';
...
b[e+1]},b[0]);return new Nb(a,jd)};(window.litElementVersions||(window.litElementVersions=[])).push("2.5.1");let kd=0;const Ob={},Ca=(b,a,c)=>{const d=c&&c.moduleId||`custom-style-module-${kd++}`;Array.isArray(a)||(a=a?[a]:[]);a.forEach(f=>{if(!(f instanceof Nb))throw Error("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`.");if(!Ob[f]){const g=document.createElement("dom-module");g.innerHTML=`\n        <template>\n          <style>${f.toString()}</style>\n        </template>\n      `;
const h=`custom-style-module-${kd++}`;g.register(h);Ob[f]=h}});const e=document.createElement("dom-module");if(b){const f=window.customElements&&window.customElements.get(b);f&&f.hasOwnProperty("__finalized")&&console.warn(`The custom element definition for "${b}"\n      was finalized before a style module was registered.\n      Make sure to add component specific style modules before\n      importing the corresponding custom element.`);e.setAttribute("theme-for",b)}e.innerHTML=`\n    <template>\n      ${(c&&
c.include||[]).map(f=>`<style include=${f}></style>`)}\n      ${a.map(f=>`<style include=${Ob[f]}></style>`)}\n    </template>\n  `;e.register(d)};Ca("vaadin-checkbox",Ba`
  ...
  `,{moduleId:"lumo-checkbox"});let kf=0;const E=function(b){let a=b.__mixinApplications;a||(a=new WeakMap,b.__mixinApplications=a);let c=kf++;return function(d){let e=d.__mixinSet;if(e&&e[c])return d;let f=a,g=f.get(d);g||(g=b(d),f.set(d,g),d=Object.create(g.__mixinSet||e||null),d[c]=!0,g.__mixinSet=d);return g}},q=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?b=>ShadyDOM.patch(b):b=>b,Ma={},le=/-[a-z]/g,me=/([A-Z])/g;let lf=0,ld=0,ea=[],mf=0,
Pb=!1,md=document.createTextNode("");(new window.MutationObserver(function(){Pb=!1;const b=ea.length;for(let a=0;a<b;a++){let c=ea[a];if(c)try{c()}catch(d){setTimeout(()=>{throw d;})}}ea.splice(0,b);ld+=b})).observe(md,{characterData:!0});const I={after(b){return{run(a){return window.setTimeout(a,b)},cancel(a){window.clearTimeout(a)}}},run(b,a){return window.setTimeout(b,a)},cancel(b){window.clearTimeout(b)}},L={run(b){return window.requestAnimationFrame(b)},cancel(b){window.cancelAnimationFrame(b)}},
nd={run(b){return window.requestIdleCallback?window.requestIdleCallback(b):window.setTimeout(b,16)},cancel(b){window.cancelIdleCallback?window.cancelIdleCallback(b):window.clearTimeout(b)}},F={run(b){Pb||(Pb=!0,md.textContent=mf++);ea.push(b);return lf++},cancel(b){const a=b-ld;if(0<=a){if(!ea[a])throw Error("invalid async handle: "+b);ea[a]=null}}},nf=F,od=E(b=>{class a extends b{static createProperties(c){const d=this.prototype;for(let e in c)e in d||d._createPropertyAccessor(e)}static attributeNameForProperty(c){return c.toLowerCase()}static typeForProperty(c){}_createPropertyAccessor(c,
...
"":void 0;default:return null!=c?c.toString():void 0}}_deserializeValue(c,d){switch(d){case Boolean:return null!==c;case Number:return Number(c);default:return c}}}return a}),pd={};let Za=HTMLElement.prototype;for(;Za;){let b=Object.getOwnPropertyNames(Za);for(let a=0;a<b.length;a++)pd[b[a]]=!0;Za=Object.getPrototypeOf(Za)}const qd=E(b=>{b=od(b);class a extends b{static createPropertiesForAttributes(){let c=this.observedAttributes;for(let d=0;d<c.length;d++)this.prototype._createPropertyAccessor(hc(c[d]))}static attributeNameForProperty(c){return Na(c)}_initializeProperties(){this.__dataProto&&
...
window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(c);d=d||this.constructor._parseTemplate(c);let e=d.nodeInfoList;c=document.importNode(d.content||c.content,!0);c.__noInsertionPoint=!d.hasInsertionPoint;let f=c.nodeList=Array(e.length);c.$={};for(let k=0,l=e.length,m;k<l&&(m=e[k]);k++){let n=f[k]=ic(c,m);m.id&&(c.$[m.id]=n);var g=n,h=d;m.templateInfo&&(g._templateInfo=m.templateInfo,g._parentTemplateInfo=h);g=n;h=m;if(h.events&&h.events.length)for(let p=0,r=h.events,
...
qf=/[A-Z]/,td=(b,a,c,d,e)=>{var f=e?J(b):b;if(a=a[f])for(f=0;f<a.length;f++){var g=a[f];if(g.info.lastRun!==na&&(!e||qb(b,g.trigger))){g.info.lastRun=na;g=g.info;var h=c,k=d;let l=0,m=h.length-1,n=-1;for(;l<=m;){const p=l+m>>1,r=k.get(h[p].methodInfo)-k.get(g.methodInfo);if(0>r)l=p+1;else if(0<r)m=p-1;else{n=p;break}}0>n&&(n=m+1);h.splice(n,0,g)}}},ue=[],ud=RegExp("(\\[\\[|{{)\\s*(?:(!)\\s*)?((?:[a-zA-Z_$][\\w.:$\\-*]*)\\s*(?:\\(\\s*(?:(?:(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*)(?:,\\s*(?:((?:[a-zA-Z_$][\\w.:$\\-*]*)|(?:[-+]?[0-9]*\\.?[0-9]+(?:[eE][-+]?[0-9]+)?)|(?:(?:'(?:[^'\\\\]|\\\\.)*')|(?:\"(?:[^\"\\\\]|\\\\.)*\")))\\s*))*)?)\\)\\s*)?)(?:]]|}})",
"g"),$a=E(b=>{const a=pf(qd(b));class c extends a{constructor(){super();this.__isPropertyEffectsClient=!0;this.__dataClientsReady;this.__dataPendingClients;this.__dataToNotify;this.__dataLinkedPaths;this.__dataHasPaths;this.__dataCompoundStorage;this.__dataHost;this.__dataTemp;this.__dataClientsInitialized;this.__data;this.__dataPending;this.__dataOld;this.__computeEffects;this.__computeInfo;this.__reflectEffects;this.__notifyEffects;this.__propagateEffects;this.__observeEffects;this.__readOnly;this.__templateInfo;
...
e){for(let f in d)!e&&this[t.READ_ONLY]&&this[t.READ_ONLY][f]||this._setPendingPropertyOrPath(f,d[f],!0);this._invalidateProperties()}ready(){this._flushProperties();this.__dataClientsReady||this._flushClients();this.__dataPending&&this._flushProperties()}_propertiesChanged(d,e,f){d=this.__dataHasPaths;this.__dataHasPaths=!1;var g;if(g=this[t.COMPUTE])if(ef){na++;var h=qe(this),k=[];for(var l in e)td(l,g,k,h,d);for(;l=k.shift();)lc(this,"",e,f,l)&&td(l.methodInfo,g,k,h,d);Object.assign(f,this.__dataOld);
Object.assign(e,this.__dataPending);this.__dataPending=null}else for(h=e;ma(this,g,h,f,d);)Object.assign(f,this.__dataOld),Object.assign(e,this.__dataPending),h=this.__dataPending,this.__dataPending=null;g=this.__dataToNotify;this.__dataToNotify=null;this._propagatePropertyChanges(e,f,d);this._flushClients();ma(this,this[t.REFLECT],e,f,d);ma(this,this[t.OBSERVE],e,f,d);if(g){h=this[t.NOTIFY];let G;k=na++;for(let T in g)if(g[T]){if(l=h){var m=h;l=k;var n=T,p=e,r=f,v=d;let vd=!1,rf=v?J(n):n;if(m=m[rf])for(let Qb=
0,sf=m.length,U;Qb<sf&&(U=m[Qb]);Qb++)U.info&&U.info.lastRun===l||v&&!qb(n,U.trigger)||(U.info&&(U.info.lastRun=l),U.fn(this,n,p,r,U.info,v,void 0),vd=!0);l=vd}if(l)G=!0;else{if(l=d)l=T,n=e,p=J(l),p!==l?(p=Na(p)+"-changed",kc(this,p,n[l],l),l=!0):l=!1;l&&(G=!0)}}let H;G&&(H=this.__dataHost)&&H._invalidateProperties&&H._invalidateProperties()}1==this.__dataCounter&&(this.__dataTemp={})}_propagatePropertyChanges(d,e,f){this[t.PROPAGATE]&&ma(this,this[t.PROPAGATE],d,e,f);this.__templateInfo&&this._runEffectsForTemplate(this.__templateInfo,
d,e,f)}_runEffectsForTemplate(d,e,f,g){const h=(k,l)=>{ma(this,d.propertyEffects,k,f,l,d.nodeList);for(let m=d.firstChild;m;m=m.nextSibling)this._runEffectsForTemplate(m,k,f,l)};d.runEffects?d.runEffects(h,e,g):h(e,g)}linkPaths(d,e){d=la(d);e=la(e);this.__dataLinkedPaths=this.__dataLinkedPaths||{};this.__dataLinkedPaths[d]=e}unlinkPaths(d){d=la(d);this.__dataLinkedPaths&&delete this.__dataLinkedPaths[d]}notifySplices(d,e){let f={path:""};d=B(this,d,f);qc(this,d,f.path,e)}get(d,e){return B(e||this,
d)}set(d,e,f){f?gc(f,d,e):this[t.READ_ONLY]&&this[t.READ_ONLY][d]||this._setPendingPropertyOrPath(d,e,!0)&&this._invalidateProperties()}push(d,...e){let f={path:""};d=B(this,d,f);let g=d.length,h=d.push(...e);e.length&&pa(this,d,f.path,g,e.length,[]);return h}pop(d){let e={path:""};d=B(this,d,e);let f=!!d.length,g=d.pop();f&&pa(this,d,e.path,d.length,0,[g]);return g}splice(d,e,f,...g){let h={path:""},k=B(this,d,h);0>e?e=k.length-Math.floor(-e):e&&(e=Math.floor(e));let l;l=2===arguments.length?k.splice(e):
k.splice(e,f,...g);(g.length||l.length)&&pa(this,k,h.path,e,g.length,l);return l}shift(d){let e={path:""};d=B(this,d,e);let f=!!d.length,g=d.shift();f&&pa(this,d,e.path,0,0,[g]);return g}unshift(d,...e){let f={path:""};d=B(this,d,f);let g=d.unshift(...e);e.length&&pa(this,d,f.path,0,e.length,[]);return g}notifyPath(d,e){if(1==arguments.length){var f={path:""};e=B(this,d,f);f=f.path}else f=Array.isArray(d)?la(d):d;this._setPendingPropertyOrPath(f,e,!0,!0)&&this._invalidateProperties()}_createReadOnlyProperty(d,
e){this._addPropertyEffect(d,t.READ_ONLY);e&&(this["_set"+we(d)]=function(f){this._setProperty(d,f)})}_createPropertyObserver(d,e,f){let g={property:d,method:e,dynamicFn:!!f};this._addPropertyEffect(d,t.OBSERVE,{fn:jc,info:g,trigger:{name:d}});f&&this._addPropertyEffect(e,t.OBSERVE,{fn:jc,info:g,trigger:{name:e}})}_createMethodObserver(d,e){let f=tb(d);if(!f)throw Error("Malformed observer expression '"+d+"'");nc(this,f,t.OBSERVE,rb,null,e)}_createNotifyingProperty(d){this._addPropertyEffect(d,t.NOTIFY,
{fn:oe,info:{eventName:Na(d)+"-changed",property:d}})}_createReflectedProperty(d){let e=this.constructor.attributeNameForProperty(d);"-"===e[0]?console.warn("Property "+d+" cannot be reflected to attribute "+e+' because "-" is not a valid starting attribute name. Use a lowercase first letter for the property instead.'):this._addPropertyEffect(d,t.REFLECT,{fn:pe,info:{attrName:e}})}_createComputedProperty(d,e,f){let g=tb(e);if(!g)throw Error("Malformed computed expression '"+e+"'");e=nc(this,g,t.COMPUTE,
lc,d,f);pb(this,"__computeInfo")[d]=e}_marshalArgs(d,e,f){const g=this.__data,h=[];for(let k=0,l=d.length;k<l;k++){let {name:m,structured:n,wildcard:p,value:r,literal:v}=d[k];if(!v)if(p){const G=0===e.indexOf(m+"."),H=pc(g,f,G?e:m);r={path:G?e:m,value:H,base:G?B(g,m):H}}else r=n?pc(g,f,m):g[m];if(ub&&!this._overrideLegacyUndefined&&void 0===r&&1<d.length)return oa;h[k]=r}return h}static addPropertyEffect(d,e,f){this.prototype._addPropertyEffect(d,e,f)}static createPropertyObserver(d,e,f){this.prototype._createPropertyObserver(d,
...
e){e=e||this._bindTemplate(d,!0);Da.push(this);d=super._stampTemplate(d,e);Da.pop();e.nodeList=d.nodeList;if(!e.wasPreBound){var f=e.childNodes=[];for(var g=d.firstChild;g;g=g.nextSibling)f.push(g)}d.templateInfo=e;let {nodeList:h,nodeInfoList:k}=e;if(k.length)for(let m=0;m<k.length;m++){let n=h[m],p=k[m].bindings;if(p)for(let r=0;r<p.length;r++){let v=p[r];f=n;g=v;if(g.isCompound){let G=f.__dataCompoundStorage||(f.__dataCompoundStorage={});var l=g.parts;let H=Array(l.length);for(let T=0;T<l.length;T++)H[T]=
l[T].literal;l=g.target;G[l]=H;g.literal&&"property"==g.kind&&("className"===l&&(f=q(f)),f[l]=g.literal)}te(n,this,v)}n.__dataHost=this}this.__dataClientsReady&&(this._runEffectsForTemplate(e,this.__data,null,!1),this._flushClients());return d}_removeBoundDom(d){d=d.templateInfo;const {previousSibling:e,nextSibling:f,parent:g}=d;e?e.nextSibling=f:g&&(g.firstChild=f);f?f.previousSibling=e:g&&(g.lastChild=e);d.nextSibling=d.previousSibling=null;d=d.childNodes;for(let h=0;h<d.length;h++){let k=d[h];
q(q(k).parentNode).removeChild(k)}}static _parseTemplateNode(d,e,f){let g=a._parseTemplateNode.call(this,d,e,f);if(d.nodeType===Node.TEXT_NODE){let h=this._parseBindings(d.textContent,e);h&&(d.textContent=oc(h)||" ",sb(this,e,f,"text","textContent",h),g=!0)}return g}static _parseTemplateNodeAttribute(d,e,f,g,h){let k=this._parseBindings(h,e);if(k){h=g;let l="property";qf.test(g)?l="attribute":"$"==g[g.length-1]&&(g=g.slice(0,-1),l="attribute");let m=oc(k);m&&"attribute"==l&&("class"==g&&d.hasAttribute("class")&&
(m+=" "+d.getAttribute(g)),d.setAttribute(g,m));"attribute"==l&&"disable-upgrade$"==h&&d.setAttribute(g,"");"input"===d.localName&&"value"===h&&d.setAttribute(h,"");d.removeAttribute(h);"property"===l&&(g=hc(g));sb(this,e,f,l,g,k,m);return!0}return a._parseTemplateNodeAttribute.call(this,d,e,f,g,h)}static _parseTemplateNestedTemplate(d,e,f){let g=a._parseTemplateNestedTemplate.call(this,d,e,f);const h=d.parentNode,k=f.templateInfo,l="dom-if"===h.localName,m="dom-repeat"===h.localName;bd&&(l||m)&&
(h.removeChild(d),f=f.parentInfo,f.templateInfo=k,f.noted=!0,g=!1);d=k.hostProps;if(cd&&l)d&&(e.hostProps=Object.assign(e.hostProps||{},d),bd||(f.parentInfo.noted=!0));else for(let n in d)sb(this,e,f,"property","_host_"+n,[{mode:"{",source:n,dependencies:[n],hostProp:!0}]);return g}static _parseBindings(d,e){let f=[];for(var g=0,h;null!==(h=ud.exec(d));){h.index>g&&f.push({literal:d.slice(g,h.index)});g=h[1][0];let m=!!h[2];h=h[3].trim();let n=!1,p="";var k=-1;"{"==g&&0<(k=h.indexOf("::"))&&(p=h.substring(k+
2),h=h.substring(0,k),n=!0);k=tb(h);let r=[];if(k){let {args:v,methodName:G}=k;for(var l=0;l<v.length;l++){let H=v[l];H.literal||r.push(H)}if((l=e.dynamicFns)&&l[G]||k.static)r.push(G),k.dynamicFn=!0}else r.push(h);f.push({source:h,mode:g,negate:m,customEvent:n,signature:k,dependencies:r,event:p});g=ud.lastIndex}g&&g<d.length&&(d=d.substring(g))&&f.push({literal:d});return f.length?f:null}static _evaluateBinding(d,e,f,g,h,k){d=e.signature?rb(d,f,g,h,e.signature):f!=e.source?B(d,e.source):k&&0<=f.indexOf(".")?
B(d,f):d.__data[f];e.negate&&(d=!d);return d}}return c}),Da=[],tf=E(b=>{function a(e){e=Object.getPrototypeOf(e);return e.prototype instanceof d?e:null}function c(e){if(!e.hasOwnProperty("__ownProperties")){var f=null;if(e.hasOwnProperty("properties")){var g=e.properties;if(g){f=g;g={};for(let h in f){const k=f[h];g[h]="function"===typeof k?{type:k}:k}f=g}}e.__ownProperties=f}return e.__ownProperties}b=od(b);class d extends b{static get observedAttributes(){if(!this.hasOwnProperty("__observedAttributes")){const e=
...
this._properties[e])&&e.type}_initializeProperties(){this.constructor.finalize();super._initializeProperties()}connectedCallback(){super.connectedCallback&&super.connectedCallback();this._enableProperties()}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback()}}return d}),Rb=window.ShadyCSS&&window.ShadyCSS.cssBuild,ab=E(b=>{function a(e,f,g,h){if(!Rb){const p=f.content.querySelectorAll("style"),r=ob(f);var k=ke(g),l=f.content.firstElementChild;for(var m=0;m<k.length;m++){var n=
k[m];n.textContent=e._processStyleText(n.textContent,h);f.content.insertBefore(n,l)}k=0;for(l=0;l<r.length;l++)m=r[l],n=p[k],n!==m?(m=m.cloneNode(!0),n.parentNode.insertBefore(m,n)):k++,m.textContent=e._processStyleText(m.textContent,h)}window.ShadyCSS&&window.ShadyCSS.prepareTemplate(f,g);if(ff&&Rb&&af&&(f=f.content.querySelectorAll("style"))){let p="";Array.from(f).forEach(r=>{p+=r.textContent;r.parentNode.removeChild(r)});e._styleSheet=new CSSStyleSheet;e._styleSheet.replaceSync(p)}}const c=tf($a(b));
...
(this._cancelAsync(),V.delete(this))}_cancelAsync(){this.isActive()&&(this._asyncModule.cancel(this._timer),this._timer=null)}flush(){this.isActive()&&(this.cancel(),this._callback())}isActive(){return null!=this._timer}static debounce(b,a,c){b instanceof w?b._cancelAsync():b=new w;b.setConfig(a,c);return b}}let V=new Set;const uf=function(){const b=!!V.size;V.forEach(a=>{try{a.flush()}catch(c){setTimeout(()=>{throw c;})}});return b};let vb="string"===typeof document.head.style.touchAction,Pa=["mousedown",
"mousemove","mouseup","click"],ze=[0,1,4,2];try{var wd=1===(new MouseEvent("test",{buttons:1})).buttons}catch(b){wd=!1}let ye=wd,wb=!1;(function(){try{let b=Object.defineProperty({},"passive",{get(){wb=!0}});window.addEventListener("test",null,b);window.removeEventListener("test",null,b)}catch(b){}})();let tc=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/);const xb=[],vf={button:!0,input:!0,keygen:!0,meter:!0,output:!0,textarea:!0,progress:!0,select:!0},Be={button:!0,command:!0,fieldset:!0,
input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};let uc=function(b){var a=b.sourceCapabilities;if(!a||a.firesTouchEvents)if(b.__polymerGesturesHandled={skip:!0},"click"===b.type){a=!1;let f=Qa(b);for(let g=0;g<f.length;g++){if(f[g].nodeType===Node.ELEMENT_NODE)if("label"===f[g].localName)xb.push(f[g]);else if(vf[f[g].localName]){var c=f[g],d=Array.prototype.slice.call(c.labels||[]);if(!d.length){d=[];var e=c.getRootNode();if(c.id)for(c=e.querySelectorAll(`label[for = ${c.id}]`),e=0;e<
c.length;e++)d.push(c[e])}for(c=0;c<d.length;c++)a=a||-1<xb.indexOf(d[c])}if(f[g]===A.mouse.target)return}a||(b.preventDefault(),b.stopPropagation())}},A={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};document.addEventListener("touchend",function(b){A.mouse.mouseIgnoreJob||sc(!0);A.mouse.target=Qa(b)[0];A.mouse.mouseIgnoreJob=w.debounce(A.mouse.mouseIgnoreJob,I.after(2500),function(){sc();A.mouse.target=null;A.mouse.mouseIgnoreJob=null})},wb?{passive:!0}:!1);const Qa=
window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:b=>b.composedPath&&b.composedPath()||[],qa={},aa=[];zb({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset:function(){ba(this.info)},mousedown:function(b){if(Z(b)){var a=P(b),c=this;vc(this.info,function(d){Z(d)||(ra("up",a,d),ba(c.info))},function(d){Z(d)&&ra("up",a,d);ba(c.info)});ra("down",a,b)}},touchstart:function(b){ra("down",
...
[];this.info.x=0;this.info.y=0;this.info.prevent=!1;ba(this.info)},mousedown:function(b){if(Z(b)){var a=P(b),c=this,d=function(e){let f=e.clientX,g=e.clientY;yc(c.info,f,g)&&(c.info.state=c.info.started?"mouseup"===e.type?"end":"track":"start","start"===c.info.state&&Ra("tap"),c.info.addMove({x:f,y:g}),Z(e)||(c.info.state="end",ba(c.info)),a&&Bb(c.info,a,e),c.info.started=!0)};vc(this.info,d,function(e){c.info.started&&d(e);ba(c.info)});this.info.x=b.clientX;this.info.y=b.clientY}},touchstart:function(b){b=
b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchmove:function(b){let a=P(b);b=b.changedTouches[0];let c=b.clientX,d=b.clientY;yc(this.info,c,d)&&("start"===this.info.state&&Ra("tap"),this.info.addMove({x:c,y:d}),Bb(this.info,a,b),this.info.state="track",this.info.started=!0)},touchend:function(b){let a=P(b);b=b.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:b.clientX,y:b.clientY}),Bb(this.info,a,b))}});zb({name:"tap",deps:["mousedown","click",
"touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset:function(){this.info.x=NaN;this.info.y=NaN;this.info.prevent=!1},mousedown:function(b){Z(b)&&(this.info.x=b.clientX,this.info.y=b.clientY)},click:function(b){Z(b)&&zc(this.info,b)},touchstart:function(b){b=b.changedTouches[0];this.info.x=b.clientX;this.info.y=b.clientY},touchend:function(b){zc(this.info,b.changedTouches[0],b)}});const Fa=E(b=>{class a extends b{_addEventListenerToNode(c,
d,e){yb(c,d,e)||super._addEventListenerToNode(c,d,e)}_removeEventListenerFromNode(c,d,e){if(qa[d]){var f=qa[d];var g=f.deps;f=f.name;let h=c.__polymerGestures;if(h)for(let k=0,l,m;k<g.length;k++)l=g[k],(m=h[l])&&m[f]&&(m[f]=(m[f]||1)-1,m._count=(m._count||1)-1,0===m._count&&c.removeEventListener(l,wc,rc(l)));c.removeEventListener(d,e);g=!0}else g=!1;g||super._removeEventListenerFromNode(c,d,e)}}return a}),wf=b=>class extends b{static get properties(){return{theme:{type:String,readOnly:!0}}}attributeChangedCallback(a,
c,d){super.attributeChangedCallback(a,c,d);"theme"===a&&this._setTheme(d)}},Sb=b=>class extends wf(b){static finalize(){super.finalize();const a=this.prototype._template,c=this.template&&this.template.parentElement&&this.template.parentElement.id===this.is,d=Object.getPrototypeOf(this.prototype)._template;d&&!c&&Array.from(d.content.querySelectorAll("style[include]")).forEach(e=>{this._includeStyle(e.getAttribute("include"),a)});this._includeMatchingThemes(a)}static _includeMatchingThemes(a){const c=
...
W.indexOf(this)&&W.push(this):-1<W.indexOf(this)&&W.splice(W.indexOf(this),1)}__getNormalizedScrollLeft(a){return Tb.getNormalizedScrollLeft(cb,this.getAttribute("dir")||"ltr",a)}__setNormalizedScrollLeft(a,c){return Tb.setNormalizedScrollLeft(cb,this.getAttribute("dir")||"ltr",a,c)}},Ee=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Sa=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;window.Vaadin=window.Vaadin||{};const xd=function(b,a){if(window.Vaadin.developmentMode)return Ac(b,
a)};if(void 0===window.Vaadin.developmentMode){var zf=window.Vaadin;try{var yd=localStorage.getItem("vaadin.developmentmode.force")?!0:0<=["localhost","127.0.0.1"].indexOf(window.location.hostname)?Sa?!De():!Ce():!1}catch(b){yd=!1}zf.developmentMode=yd}const zd=function(){if("function"===typeof xd)return xd(Fe)};window.Vaadin||(window.Vaadin={});window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.developmentModeCallback=window.Vaadin.developmentModeCallback||{};window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=
function(){zd&&zd()};let Wb;const Ad=new Set,Bd=b=>class extends Vb(b){static finalize(){super.finalize();const {is:a}=this;a&&!Ad.has(a)&&(window.Vaadin.registrations.push(this),Ad.add(a),window.Vaadin.developmentModeCallback&&(Wb=w.debounce(Wb,nd,()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()}),V.add(Wb)))}constructor(){super();null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add \x3c!DOCTYPE html\x3e to the HTML document.')}};
class Cd extends Bd(yf(Sb(Fa(M)))){static get template(){return Ea`
      <style>
        :host {
          display: inline-block;
        }
...
"a"===b.target.localName?!1:!0}_handleClick(b){this.__interactionsAllowed(b)&&(this.indeterminate?(this.indeterminate=!1,b.preventDefault(),this._toggleChecked()):b.composedPath()[0]!==this._nativeCheckbox&&(b.preventDefault(),this._toggleChecked()))}_toggleChecked(){this.checked=!this.checked;this.dispatchEvent(new CustomEvent("change",{composed:!1,bubbles:!0}))}}customElements.define(Cd.is,Cd);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-select-all-checkbox-lumo"});let Ta=!1,Cc=[],Dc=[];class Hc{constructor(){this.end=this.start=0;this.rules=this.parent=this.previous=null;this.cssText=this.parsedCssText="";this.atRule=!1;this.type=0;this.parsedSelector=this.selector=this.keyframesName=""}}const Q={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,MIXIN_RULE:1E3},K={comments:/\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,customProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,mixinProp:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,
mixinApply:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,varApply:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,keyframesRule:/^@[^\s]*keyframes/,multipleSpaces:/\s+/g},Dd=new Set;window.ShadyDOM&&window.ShadyDOM.wrap||(b=>b);const Af=/;\s*/m,Bf=/^\s*(initial)|(inherit)\s*$/,Ed=/\s*!important/;class Cf{constructor(){this._map={}}set(b,a){b=b.trim();this._map[b]={properties:a,dependants:{}}}get(b){b=b.trim();return this._map[b]||null}}let db=null;class C{constructor(){this._measureElement=this._currentElement=
null;this._map=new Cf}detectMixin(b){b=Va.test(b)||Lb.test(b);Va.lastIndex=0;Lb.lastIndex=0;return b}gatherStyles(b){var a=[];var c=b.content.querySelectorAll("style");for(let d=0;d<c.length;d++){const e=c[d];if(e.hasAttribute("shady-unscoped")){if(!Ka){const f=e.textContent;if(!Dd.has(f)){Dd.add(f);const g=document.createElement("style");g.setAttribute("shady-unscoped","");g.textContent=f;document.head.appendChild(g)}e.parentNode.removeChild(e)}}else a.push(e.textContent),e.parentNode.removeChild(e)}return(a=
a.join("").trim())?(c=document.createElement("style"),c.textContent=a,b.content.insertBefore(c,b.content.firstChild),c):null}transformTemplate(b,a){void 0===b._gatheredStyle&&(b._gatheredStyle=this.gatherStyles(b));return(b=b._gatheredStyle)?this.transformStyle(b,a):null}transformStyle(b,a=""){let c=Jc(b);this.transformRules(c,a);b.textContent=Cb(c);return c}transformCustomStyle(b){let a=Jc(b);sa(a,c=>{":root"===c.selector&&(c.selector="html");this.transformRule(c)});b.textContent=Cb(a);return a}transformRules(b,
...
nativeCss:Db,nativeShadow:Ka,cssBuild:ta,disableRuntime:ad};a&&(window.ShadyCSS.CustomStyleInterface=a)}window.ShadyCSS.ApplyShim=Ga;const Ef=/:host\(:dir\((ltr|rtl)\)\)/g,Ff=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Gf=/:dir\((?:ltr|rtl)\)/,Fd=!(!window.ShadyDOM||!window.ShadyDOM.inUse),va=[];let Ha=null,ua="";const Hf=E(b=>{Fd||Ha||(ua=document.documentElement.getAttribute("dir"),Ha=new MutationObserver(Nc),Ha.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const a=qd(b);
class c extends a{static _processStyleText(d,e){d=a._processStyleText.call(this,d,e);!Fd&&Gf.test(d)&&(d=this._replaceDirInCssText(d),this.__activateDir=!0);return d}static _replaceDirInCssText(d){d=d.replace(Ef,':host([dir\x3d"$1"])');return d=d.replace(Ff,':host([dir\x3d"$2"]) $1')}constructor(){super();this.__autoDirOptOut=!1}ready(){super.ready();this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){a.prototype.connectedCallback&&super.connectedCallback();this.constructor.__activateDir&&
(Ha&&Ha.takeRecords().length&&Nc(),va.push(this),this.__autoDirOptOut||this.setAttribute("dir",ua))}disconnectedCallback(){a.prototype.disconnectedCallback&&super.disconnectedCallback();if(this.constructor.__activateDir){const d=va.indexOf(this);-1<d&&va.splice(d,1)}}}c.__activateDir=!1;return c});"interactive"===document.readyState||"complete"===document.readyState?Oc():window.addEventListener("DOMContentLoaded",Oc);let N=class{static getFlattenedNodes(b){const a=q(b);return ca(b)?a.assignedNodes({flatten:!0}):
...
this.node.localName?q(this.node).assignedNodes({flatten:!0}):[]}getDestinationInsertionPoints(){let b=[],a=q(this.node).assignedSlot;for(;a;)b.push(a),a=q(a).assignedSlot;return b}importNode(b,a){return q(this.node instanceof Document?this.node:this.node.ownerDocument).importNode(b,a)}getEffectiveChildNodes(){return N.getFlattenedNodes(this.node)}queryDistributedElements(b){let a=this.getEffectiveChildNodes(),c=[];for(let d=0,e=a.length,f;d<e&&(f=a[d]);d++)f.nodeType===Node.ELEMENT_NODE&&Gd.call(f,
...
Node.ELEMENT_NODE})}isLightDescendant(e){return this!==e&&q(this).contains(e)&&q(this).getRootNode()===q(e).getRootNode()}isLocalDescendant(e){return this.root===q(e).getRootNode()}scopeSubtree(e,f=!1){return Re(e,f)}getComputedStyleValue(e){return If.getComputedStyleValue(this,e)}debounce(e,f,g){this._debouncers=this._debouncers||{};return this._debouncers[e]=w.debounce(this._debouncers[e],0<g?I.after(g):F,f.bind(this))}isDebouncerActive(e){this._debouncers=this._debouncers||{};e=this._debouncers[e];
return!(!e||!e.isActive())}flushDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.flush()}cancelDebouncer(e){this._debouncers=this._debouncers||{};(e=this._debouncers[e])&&e.cancel()}async(e,f){return 0<f?I.run(e.bind(this),f):~F.run(e.bind(this))}cancelAsync(e){0>e?F.cancel(~e):I.cancel(e)}create(e,f){e=document.createElement(e);if(f)if(e.setProperties)e.setProperties(f);else for(let g in f)e[g]=f[g];return e}elementMatches(e,f){return Gd.call(f||this,e)}toggleAttribute(e,
...
hostAttributes:!0},Vc={attached:!0,detached:!0,ready:!0,created:!0,beforeRegister:!0,registered:!0,attributeChanged:!0,behaviors:!0,_noAccessors:!0},Ue=Object.assign({listeners:!0,hostAttributes:!0,properties:!0,observers:!0},Vc),Jd=Id(HTMLElement),Zb=E(b=>{class a extends b{_shouldPropertyChange(c,d,e){return Gb(this,c,d,e,!0)}}return a}),Kd=E(b=>{class a extends b{static get properties(){return{mutableData:Boolean}}_shouldPropertyChange(c,d,e){return Gb(this,c,d,e,this.mutableData)}}return a});
Zb._mutablePropertyChange=Gb;let Ib=null;Hb.prototype=Object.create(HTMLTemplateElement.prototype,{constructor:{value:Hb,writable:!0}});const Yc=$a(Hb),Ze=Zb(Yc),Jf=$a(class{});class R extends Jf{constructor(b){super();this._configureProperties(b);this.root=this._stampTemplate(this.__dataHost);var a=[];this.children=a;for(let c=this.root.firstChild;c;c=c.nextSibling)a.push(c),c.__templatizeInstance=this;this.__templatizeOwner&&this.__templatizeOwner.__hideTemplateChildren__&&this._showHideChildren(!0);
...
a.nextSibling)this.__children[this.__children.length]=a;this._enableProperties()}this.__insertChildren();this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}customElements.define("dom-bind",Lf);const Mf=Kd(M);class Ld extends Mf{static get is(){return"dom-repeat"}static get template(){return null}static get properties(){return{items:{type:Array},as:{type:String,value:"item"},indexAs:{type:String,value:"index"},itemsIndexAs:{type:String,value:"itemsIndex"},sort:{type:Function,
...
this.__teardownInstance();this._showHideChildren();Mb&&!this.notifyDomChange||this.if==this._lastIf||(this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0})),this._lastIf=this.if)}__hasInstance(){}__getInstanceNodes(){}__createAndInsertInstance(b){}__teardownInstance(){}_showHideChildren(){}}class Nf extends Md{constructor(){super();this.__syncInfo=this.__instance=null}__hasInstance(){return!!this.__instance}__getInstanceNodes(){return this.__instance.templateInfo.childNodes}__createAndInsertInstance(b){const a=
...
!this.if;this.__instance&&!!this.__instance.__hidden!==b&&(this.__instance.__hidden=b,this.__instance._showHideChildren(b));b||this.__syncHostProperties()}}const Nd=cd?Nf:Of;customElements.define(Nd.is,Nd);let Pf=E(b=>{b=ab(b);class a extends b{static get properties(){return{items:{type:Array},multi:{type:Boolean,value:!1},selected:{type:Object,notify:!0},selectedItem:{type:Object,notify:!0},toggle:{type:Boolean,value:!1}}}static get observers(){return["__updateSelection(multi, items.*)"]}constructor(){super();
this.__selectedMap=this.__lastMulti=this.__lastItems=null}__updateSelection(c,d){var e=d.path;"items"==e?(d=d.base||[],e=this.__lastItems,c!==this.__lastMulti&&this.clearSelection(),e&&(e=Pc(d,0,d.length,e,0,e.length),this.__applySplices(e)),this.__lastItems=d,this.__lastMulti=c):"items.splices"==d.path?this.__applySplices(d.value.indexSplices):(c=e.slice(6),d=parseInt(c,10),0>c.indexOf(".")&&c==d&&this.__deselectChangedIdx(d))}__applySplices(c){let d=this.__selectedMap;for(let f=0;f<c.length;f++){let g=
...
this.__selectedMap.clear(),this.__selectedMap.set(d,c),this.__updateLinks(),this.multi?this.push("selected",d):this.selected=this.selectedItem=d)}}return a})(M);class Od extends Pf{static get is(){return"array-selector"}static get template(){return null}}customElements.define(Od.is,Od);const ja=Id(HTMLElement).prototype;var eb=new Set;const Qf={properties:{_parentResizable:{type:Object,observer:"_parentResizableChanged"},_notifyingDescendant:{type:Boolean,value:!1}},listeners:{"iron-request-resize-notifications":"_onIronRequestResizeNotifications"},
...
(a.removeEventListener("scroll",this._boundScrollHandler),this._boundScrollHandler=null)},toggleScrollListener:function(b){this._shouldHaveListener=b;this._toggleScrollListener(b,this.scrollTarget)}},Pd=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),Sf=Pd&&8<=Pd[1],Tf=function(b,a){b||console.warn("Polymer.Class requires `info` argument");a=a?a(Jd):Jd;a=Te(b,a,b.behaviors);a.is=a.prototype.is=b.is;return a}({behaviors:[Qf,Rf],_ratio:.5,_scrollerPaddingTop:0,_scrollPosition:0,_physicalSize:0,
...
e-1);a-=f.effectiveSize}return{cache:this,scaledIndex:a}}},$f=b=>class extends b{static get properties(){return{pageSize:{type:Number,value:50,observer:"_pageSizeChanged"},dataProvider:{type:Object,notify:!0,observer:"_dataProviderChanged"},loading:{type:Boolean,notify:!0,readOnly:!0,reflectToAttribute:!0},_cache:{type:Object,value:function(){return new Qd(this)}},itemIdPath:{type:String,value:null},expandedItems:{type:Object,notify:!0,value:()=>[]}}}static get observers(){return["_sizeChanged(size)",
...
{for(let e=a;e<a+c;e++)this._templateInstances[e].set(d,this._parentPathValues[d])})}}customElements.define(fb.is,fb);const dg=b=>class extends b{static get properties(){return{detailsOpenedItems:{type:Array,value:function(){return[]}},_rowDetailsTemplate:Object,rowDetailsRenderer:Function,_detailsCells:{type:Array}}}static get observers(){return["_detailsOpenedItemsChanged(detailsOpenedItems.*, _rowDetailsTemplate, rowDetailsRenderer)","_rowDetailsTemplateOrRendererChanged(_rowDetailsTemplate, rowDetailsRenderer)"]}_rowDetailsTemplateOrRendererChanged(a,
...
a._order=c._order;c._order=d;this._updateLastFrozen();this._updateFirstAndLastColumn()}_getTargetColumn(a,c){if(a&&c){let d=a._column;for(;d.parentElement!==c.parentElement&&d!==this;)d=d.parentElement;return d.parentElement===c.parentElement?d:a._column}}},Rd=b=>class extends b{static get properties(){return{resizable:{type:Boolean,value:function(){if("vaadin-grid-column-group"!==this.localName){var a=this.parentNode;return a&&"vaadin-grid-column-group"===a.localName?a.resizable||!1:!1}}},_headerTemplate:{type:Object},
...
this._previousHidden=a}};class gb extends Rd(Vb(M)){static get is(){return"vaadin-grid-column"}static get properties(){return{width:{type:String,value:"100px"},flexGrow:{type:Number,value:1},renderer:Function,path:{type:String},autoWidth:{type:Boolean,value:!1},_bodyTemplate:{type:Object},_cells:Array}}}customElements.define(gb.is,gb);Ca("vaadin-grid",Ba`
  ...
  `,{moduleId:"vaadin-grid-styles"});try{document.createEvent("TouchEvent");var Sd=!0}catch(b){Sd=!1}const lg=Sd;class Td extends Bd(Sb($f(Yf(ag(Xf(eg(fg(gg(dg(jg(Vf(cg(kg(Zf(bg(ig(hg(Uf)))))))))))))))))){static get template(){return Ea`
      <div
        id="scroller"
        safari$="[[_safari]]"
        ios$="[[_ios]]"
...
this._grid._updateColumnTree()})});this._observer.flush()}_isColumnElement(b){return b.nodeType===Node.ELEMENT_NODE&&/\bcolumn\b/.test(b.localName)}}customElements.define(Ud.is,Ud);class Vd extends gb{static get template(){return Ea`
...
document.head.appendChild(Wd.content);class Xd extends Sb(Vb(M)){static get template(){return Ea`
      <style>
        :host {
          display: inline-flex;
          cursor: pointer;
...
"asc"===this.direction?"desc":"desc"===this.direction?null:"asc")}}customElements.define(Xd.is,Xd);class Yd extends gb{static get template(){return Ea`
      <template class="header" id="headerTemplate">
        <vaadin-grid-sorter path="[[path]]" direction="{{direction}}">[[_getHeader(header, path)]]</vaadin-grid-sorter>
      </template>
    `}static get is(){return"vaadin-grid-sort-column"}static get properties(){return{path:String,direction:{type:String,notify:!0}}}_prepareHeaderTemplate(){const b=this._prepareTemplatizer(this.$.headerTemplate);b.templatizer.dataHost=this;return b}_getHeader(b,a){return b||this._generateHeader(a)}}customElements.define(Yd.is,Yd);const Zd={selectionColumn:!0,columnMenus:!0};let x=class extends ce{constructor(b,a){super(b,a);this._grid=null;this._columnElements=[];this._isDataLoaded=!1;this.messages=
this.itemIdPath=null;this.viewModel=new de;this.visibleElements={...Zd}}initialize(){this.addHandles([this.columns.on("change",()=>this.onColumnChange()),Ja.watch(()=>this.viewModel?.size,()=>this._updateGridSize()),Ja.watch(()=>this.store?.state,(b,a)=>{"ready"!==b||"loaded"!==a&&"error"!==a||this.refreshPageCache()}),Ja.on(()=>this.highlightIds,"change",b=>{const {added:a,removed:c}=b;b=a.map(e=>this.store?.getLocalItemByKey(e)||{objectId:e});const d=c.map(e=>this.store?.getLocalItemByKey(e)||{objectId:e});
this._deselectRows(d);this._selectRows(b)}),Ja.on(()=>this._grid?.$?.table,"scroll",()=>this.viewModel?.closeColumnMenus())])}destroy(){this.resetColumns();this.columns?.destroy()}resetColumns(){this.columns.items.forEach(b=>b.destroy());this.columns.removeAll()}get cellClassNameGenerator(){return this.viewModel.cellClassNameGenerator}set cellClassNameGenerator(b){this.viewModel.cellClassNameGenerator=b}get columns(){return this.viewModel.columns}set columns(b){this.viewModel.columns=b}get columnReorderingEnabled(){return this.viewModel.columnReorderingEnabled}set columnReorderingEnabled(b){this.viewModel.columnReorderingEnabled=
b}get dataProvider(){return this.viewModel.dataProvider}set dataProvider(b){this.viewModel.dataProvider=b}get highlightIds(){return this.viewModel.highlightIds}set highlightIds(b){this.viewModel.highlightIds=b}get label(){return this.messages?.widgetLabel??""}set label(b){this._overrideIfSome("label",b)}get multiSortEnabled(){return this.viewModel.multiSortEnabled}set multiSortEnabled(b){this.viewModel.multiSortEnabled=b}get pageSize(){return this.viewModel.pageSize}set pageSize(b){this.viewModel.pageSize=
b}get rowDetailsRenderer(){return this.viewModel.rowDetailsRenderer}set rowDetailsRenderer(b){this.viewModel.rowDetailsRenderer=b}get size(){return this.viewModel.size}get sortOrders(){return this._grid?._sorters?this._grid._sorters.filter(b=>!!b).map(({direction:b,path:a})=>({direction:b,path:a})):[]}get store(){return this.viewModel.store}set store(b){this.viewModel.store=b}castVisibleElements(b){return{...Zd,...b}}getColumnProps(b,a){const {id:c}=this,{autoWidth:d,direction:e,flexGrow:f,frozen:g,
header:h,hidden:k,path:l,resizable:m,textAlign:n,width:p}=b;return{autoWidth:d,direction:e,flexGrow:f,frozen:g,header:h,hidden:k,key:`${c}_${h}_${a??l}`,path:l,resizable:m,"text-align":n,width:"number"===typeof p?`${p}px`:p,bind:this,afterCreate:this._afterColumnCreate,afterRemoved:this._afterColumnRemoved}}clearSelection(){this._clearSelection();this.scheduleRender()}clearSort(){let b=!1;this._grid&&(this._grid._sorters?.length&&(this._grid._sorters.forEach(a=>{a._order=null;a.direction=null}),b=
!0),this.columns?.length&&this.columns.some(a=>!!a.direction)&&(this.columns.forEach(a=>a.direction=null),b=!0),b&&(this.notifyChange("sortOrders"),this.scheduleRender()))}findColumn(b){this.viewModel.findColumn(b)}generateCellClassNames(){this._grid?.generateCellClassNames()}getSlotElementByName(b){return this._grid?.shadowRoot?.querySelector(`slot[name='${b}']`)??null}hideColumn(b){this.viewModel?.hideColumn(b);this.scheduleRender()}notifyResize(){this._grid?.notifyResize()}recalculateColumnWidths(){this._grid?.recalculateColumnWidths()}async reset(){this._isDataLoaded=
!1;this._clearSelection();await this.store?.reset();this.scrollToTop()}refreshPageCache(){this._grid?.clearCache()}selectRows(b){b=b?.filter(c=>!this.highlightIds.includes(c.objectId));const a=b.map(c=>c.objectId);a.length&&(this.highlightIds.addMany(a),this._selectRows(b))}deselectRows(b){const a=b?.map(c=>c.objectId)||[];a.length&&(this.highlightIds.removeMany(a),this._deselectRows(b))}showColumn(b){this.viewModel?.showColumn(b);this.scheduleRender()}sort({path:b,direction:a}){this.viewModel?.sortColumn(b,
a);this.notifyChange("sortOrders")}scrollToIndex(b){this._grid?.scrollToIndex(b)}scrollToTop(){this._grid?.scrollToIndex(0)}isEditingActive(){return!!this._getActiveEditInfo().length}onColumnChange(){this._syncColumnRenderers()}render(){const {columnMenus:b}=this.visibleElements;return Y.tsx("div",{bind:this,class:this.classes("esri-grid",ee.globalCss.widget,{["esri-grid--no-column-menu"]:!b})},Y.tsx("div",{bind:this,class:"esri-grid__content"},this._renderGrid()))}_renderGrid(){return Y.tsx("vaadin-grid",
{_safari:!1,afterCreate:this._afterGridCreate,afterUpdate:this._afterGridUpdate,bind:this,cellClassNameGenerator:this.cellClassNameGenerator,class:"esri-grid__grid",columnReorderingAllowed:this.columnReorderingEnabled,dataProvider:this.dataProvider,id:`${this.id}_grid`,itemIdPath:this.itemIdPath,multiSort:this.multiSortEnabled,pageSize:this.pageSize,ref:"grid",rowDetailsRenderer:this.rowDetailsRenderer,size:this.size},this._renderAllColumns())}_renderAllColumns(){return"disabled"!==this.viewModel.state&&
this.columns?.length?[this._renderSelectionColumn(),this._renderColumns()]:null}_renderSelectionColumn(){return Y.tsx("vaadin-grid-selection-column",{_selectAllHidden:!0,bind:this,frozen:!fe.isRTL(this.container),hidden:!this.visibleElements.selectionColumn,selectAll:!1,sortable:!1})}_renderColumns(){return this.columns.items.map((b,a)=>"columns"in b?this._renderGroupColumn(b,a):Y.tsx("vaadin-grid-column",{...this.getColumnProps(b,a)})).filter($d.isSome)}_renderGroupColumn(b,a){const c=this.getColumnProps(b,
a);if(c.hidden||!b.columns)return null;b=b.columns.filter(({hidden:d})=>!d);return b.length?Y.tsx("vaadin-grid-column-group",{...c},b.map(d=>Y.tsx("vaadin-grid-column",{...this.getColumnProps(d,a)}))):null}_afterGridCreate(b){const a=this._grid=b;a.setAttribute("theme","compact column-borders");customElements.whenDefined("vaadin-grid").then(()=>this._addGridEventListeners());a.__updateSorter=c=>{var d=a._sorters;const e=!d.includes(c);if(c.direction||!e)c._order=null,a.multiSort?(a._removeArrayItem(d,
c),c.direction&&(null!=c._initialOrder?(e?d[c._initialOrder]=c:d.splice(c._initialOrder,0,c),c._initialOrder=null):d.unshift(c)),a.__updateSortOrders()):c.direction&&(d=d.filter(f=>f!==c),a._sorters=[c],d.forEach(f=>{f._order=null;f.direction=null}))}}_afterGridUpdate(b){this._grid||(this._grid=b)}_afterColumnCreate(b){this._applyRenderersToColumnElement(b);this._columnElements.push(b)}_afterColumnRemoved(b){b=this._columnElements.indexOf(b,0);-1<b&&this._columnElements.splice(b,1)}_syncColumnRenderers(){this._columnElements.forEach(b=>
{this._applyRenderersToColumnElement(b)})}_updateGridSize(){this._grid&&(this._grid.size=this.size||0,this.scheduleRender())}_getActiveEditInfo(){return!this.columns||this.columns.length?[]:this.columns.filter(b=>"activeEditInfo"in b).map(b=>b.activeEditInfo).items}_addGridEventListeners(){const b=this._grid;$b.assertIsSome(b);this.addHandles([Ia.on(b,"click",a=>this._onRowClick(a)),Ia.on(b,"selected-items-changed",a=>this._onSelectionChange(a)),Ia.on(b,"sorter-changed",()=>this.notifyChange("sortOrders")),
Ia.on(b,"loading-changed",a=>{this._isDataLoaded||!1!==a.detail.value||(this._isDataLoaded=!0,this._selectRowsOnLoad())})])}_onRowClick(b){var a=this._grid;$b.assertIsSome(a);a=a.getEventContext(b);const {item:c,section:d}=a;c&&d&&"details"!==d&&"header"!==d&&this.emit("row-click",{context:a,native:b})}_clearSelection(){this._grid&&(this.highlightIds.removeAll(),this._grid.selectedItems=[],this._grid.render())}_selectRowsOnLoad(){const b=this._grid;if(b){var a=b.selectedItems.slice();(this.highlightIds?.filter(c=>
0>a.findIndex(d=>d.objectId===c))).forEach(c=>b.selectedItems.push(this.store?.getLocalItemByKey(c)||{objectId:c}));b.render()}}_selectRows(b){const a=this._grid;if(a){var c=a.selectedItems.slice();b.filter(d=>0>c.findIndex(e=>e.objectId===d.objectId)).forEach(d=>a.selectedItems.push(d));a.render()}}_deselectRows(b){const a=this._grid;if(a){var c=a.selectedItems.slice();b.forEach(d=>{const e=c.findIndex(f=>f.objectId===d.objectId);-1<e&&c.splice(e,1)});a.selectedItems=c;a.render()}}_onSelectionChange(b){if("selectedItems.splices"===
b.detail.path){const {removed:a,object:c}=b.detail.value.indexSplices[0];b=c.filter(e=>!this.highlightIds.includes(e.objectId)).map(e=>e.objectId);const d=a.filter(e=>this.highlightIds.includes(e.objectId)).map(e=>e.objectId);this.highlightIds.removeMany(d);this.highlightIds.addMany(b)}}_applyRenderersToColumnElement(b){var a=b?.path;if(a=null!=a?this.viewModel.findColumn(a):void 0)try{const {renderFunction:c,footerRenderFunction:d,headerRenderFunction:e}=a;c&&"renderer"in b&&(b.renderer=(f,g,h)=>
c({root:f,column:g,rowData:h}));d&&(b.footerRenderer=(f,g)=>d({root:f,column:g}));e&&(b.headerRenderer=(f,g)=>e({root:f,column:g}))}catch(c){}}};y.__decorate([z.property()],x.prototype,"_grid",void 0);y.__decorate([z.property()],x.prototype,"_isDataLoaded",void 0);y.__decorate([z.property()],x.prototype,"cellClassNameGenerator",null);y.__decorate([z.property()],x.prototype,"columns",null);y.__decorate([z.property()],x.prototype,"columnReorderingEnabled",null);y.__decorate([z.property()],x.prototype,
"dataProvider",null);y.__decorate([z.property()],x.prototype,"highlightIds",null);y.__decorate([z.property()],x.prototype,"itemIdPath",void 0);y.__decorate([z.property()],x.prototype,"label",null);y.__decorate([z.property(),ge.messageBundle("esri/widgets/FeatureTable/t9n/FeatureTable")],x.prototype,"messages",void 0);y.__decorate([z.property()],x.prototype,"multiSortEnabled",null);y.__decorate([z.property()],x.prototype,"pageSize",null);y.__decorate([z.property()],x.prototype,"rowDetailsRenderer",
null);y.__decorate([z.property()],x.prototype,"size",null);y.__decorate([z.property({readOnly:!0})],x.prototype,"sortOrders",null);y.__decorate([z.property()],x.prototype,"store",null);y.__decorate([z.property()],x.prototype,"viewModel",void 0);y.__decorate([z.property()],x.prototype,"visibleElements",void 0);y.__decorate([ae.cast("visibleElements")],x.prototype,"castVisibleElements",null);return x=y.__decorate([be.subclass("esri.widgets.FeatureTable.Grid.Grid")],x)});